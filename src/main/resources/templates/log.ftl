...
<div class="page-container">
    ...
    <table class="table table-border table-bordered table-bg table-hover table-sort">
        ...
        <tr class="text-c" v-for="(item,index) in result">
            ...
            <td>
                <a href="#" @click="searchEvent(item.pid)"><img src="/img/6.jpg" style="width: 20px;height: 20px"/></a>&nbsp;&nbsp;
                <a href="#" @click="deleteEvent(item.pid)"><img src="/img/1.jpg" style="width: 20px;height: 20px"/></a>
            </td>
        </tr>
        </tbody>
    </table>
