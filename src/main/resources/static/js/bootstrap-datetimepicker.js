  ...
  Datetimepicker.prototype = {
   ...
   //    $(".day").removeClass("new");
    ...
    click: function (e) {
      ...
      hours = this.viewDate.getUTCHours(),
      flagmonth = month*1+1;
      //$("#today").val(year+'-'+flagmonth+'-'+day);
      // console.log(year+'年'+flagmonth+'月'+day+'日'+hours+'时');
      var Ymd = year+'-'+flagmonth+'-'+day;
      if(flag == 1){
          $(".day").each(function(){
            $(this).attr("class",'day disabled')    
          })
      }
      var todaytime = year+'-'+flagmonth+'-'+day;   
      text_();   
      get_play_ajax(todaytime);
