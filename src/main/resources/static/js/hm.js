(function () {
    var h = {}, mt = {}, c = {
        id: "92ccc5eceb3aa1534ed26f5ce1a7acd2",
        dm: ["daofengdj.com"],
    ...
    mt.lang.C = function (b, a) {
        ...
        if (Array.prototype.indexOf) d = -1 !== b.indexOf(a); else for (var l = 0; l < b.length; l++) if (b[l] === a) {
            d = s;
            break
        }
        return d
    ...
    (function () {
        ...
        mt.e.getAttribute = function (a, b) {
            ...
            if (!l && a.attributes && a.attributes.length) for (var f = a.attributes, k = f.length, n = 0; n < k; n++) f[n].nodeName === b && (l = f[n].nodeValue);
            return l
        };
        mt.e.K = function (a) {
            var b = "document";
        ...
        (function () {
            (mt.e.za = function () {
                ...
                (function () {
                    if (!l) if (l = s, "complete" === document.readyState) a.N = s; else if (document.addEventListener) document.addEventListener("DOMContentLoaded", k, u), window.addEventListener("load", a, u); else if (document.attachEvent) {
    ...
    mt.localStorage.remove = function (b) {
        if (window.localStorage) window.localStorage.removeItem(b); else if (mt.localStorage.Q()) try {
    ...
    mt.Aa.log = function (b, a) {
        var d = new Image, l = "mini_tangram_log_" + Math.floor(2147483648 * Math.random()).toString(36);
        window[l] = d;
    ...
    (function () {
        var b = mt.lang, a = mt.e, d = mt.event, l = mt.g, f = h.l, k = h.r, n = +new Date, m = [], e = {
            oa: function () {
                return function (g) {
                    if (h.a && h.a.D && c.aet && c.aet.length) {
                        var d = g.target || g.srcElement;
                        if (d) {
                            var p = h.a.na, q = a.getAttribute(d, f.ma) != t ? s : u;
                            if (a.getAttribute(d, f.la) == t) if (q) e.R(e.Y(d, g)); else {
                                var k = a.K(d);
                                if (b.C(p, "*") || b.C(p, k)) e.R(e.Y(d, g)); else for (; d.parentNode != t;) {
                                    var q = d.parentNode, k = a.K(q), l = "a" === k && b.C(p, "a") ? s : u,
    ...
    (function () {
        var b = mt.event, a = mt.g, d = h.l, l = h.r, f = +new Date, k = [], n = t, m = {
            La: function () {
                return function () {
    ...
    (function () {
        var b = mt.e, a = h.l, d = h.load, l = h.pa;
        h.r.c("pv-b", function () {
            var f = a.protocol + "//crs.baidu.com/";
            c.rec && b.za(function () {
                for (var k = 0, n = c.rp.length; k < n; k++) {
                    var m = c.rp[k][0], e = c.rp[k][1], g = b.qa("hm_t_" + m);
    ...
    (function () {
        ...
        function a() {
            ...
            if ((!n || !e) && m && g) x = s, p = +new Date; else if (n && e && (!m || !g)) x = u, q += +new Date - p;
            n = m;
            e = g;
            z = setTimeout(a, 100)
        }
        ...
        function d(a) {
            var g = document, b = "";
            if (a in g) b = a; else for (var p = ["webkit", "ms", "moz", "o"], d = 0; d < p.length; d++) {
        ...
        var f = mt.event, k = h.r, n = s, m = s, e = s, g = s, v = +new Date, p = v, q = 0, x = s,
            w = d("visibilityState"), y = d("hidden"), z;
        a();
        (function () {
    ...
    (function () {
        var b = mt.lang, a = h.l, d = h.load, l = {
            gb: function (f) {
    ...
    (function () {
        function b(a, b, p, d) {
            if (!(a === r || b === r || d === r)) {
                ...
                a = String(a).split("!");
                for (var e, k = u, f = 0; f < a.length; f++) if (e = a[f].split("*"), String(b) === e[0]) {
                    e[1] = p;
                    e[2] = d;
                    a[f] = e.join("*");
                    k = s;
        ...
        var d = mt.lang, l = mt.m, f = mt.g, k = h.l, n = h.r, m = h.Ja, e = {
            F: [], O: 0, wa: u, p: {ia: "", page: ""}, init: function () {
                e.f =
                    0;
                n.c("pv-b", function () {
                    e.Ka();
                ...
                var a = window._hmt;
                if (a && a.cmd && a.cmd[c.id]) for (var b = a.cmd[c.id], d = /^_track(Event|MobConv|Order|RTEvent)$/, q = 0, k = b.length; q < k; q++) {
                    var f = b[q];
                ...
                if (d.d(b, "Object")) {
                    ...
                    if (900 >= p) f.call(this, b); else for (var p = Math.ceil(p / 900), q = "block|" + Math.round(Math.random() * k.G).toString(16) + "|" + p + "|", n = [], w = 0; w < p; w++) n.push(w), n.push(b.substring(900 * w, 900 * w + 900)), f.call(this, q + n.join("|")), n = []
                }
    ...
    (function () {
        ...
        var a = mt.url, d = mt.Aa, l = mt.ha, f = mt.lang, k = mt.cookie, n = mt.g, m = mt.localStorage,
            e = mt.sessionStorage, g = h.l, v = h.r;
        b.prototype = {
            ca: function (a, b) {
                a = "." + a.replace(/:\d+/, "");
                b = "." + b.replace(/:\d+/, "");
                ...
                try {
                    k.set(a, b, {domain: this.X(), path: this.ra(), W: d}), d ? m.set(a, b, d) : e.set(a, b)
                } catch (g) {
                }
            }, ib: function (a) {
                try {
                    k.set(a, "", {domain: this.X(), path: this.ra(), W: -1}),
                ...
                var b = document.location.hash.substring(1), d = RegExp(c.id),
                    e = a.Z(document.referrer) === g.Fa ? 1 : 0, f = a.k(b, "jn"),
    ...
    (function () {
        var b = mt.event, a = mt.lang, d = h.l;
    ...
    (function () {
        var b = mt.g, a = mt.lang, d = mt.event, l = mt.m;
        if ("undefined" !== typeof h.a && (c.med || (!b.ua || 7 < b.fb) && c.cvcc)) {
            var f, k, n, m, e = function (a) {
                ...
                e.v = b;
                if (d) {
                    var g = d.getAttribute("href"), k = d.getAttribute("onclick") ? "" + d.getAttribute("onclick") : t,
                        m = d.getAttribute("id") || "";
            ...
            if ("undefined" !== typeof m && "undefined" !== typeof n) {
                ...
                var x = function (b, d) {
                    ...
                    if (a.d(d, "Array") || a.d(d, "NodeList")) for (var e = 0, f = d.length; e < f; e++) if (q === d[e]) return v(k + b + "/" + (e + 1), d[e]), u
                };
    ...
    (function () {
        var b = mt.e, a = mt.lang, d = mt.event, l = mt.m;
    ...
    (function () {
        ...
        if (c.med && "undefined" !== typeof h.a) {
            var d = +new Date, l = {n: "anti", sb: 0, kb: 0, clk: 0}, f = function () {
                h.a.b.et = 86;
