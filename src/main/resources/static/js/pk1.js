!function (t, e) {
    ...
    function a(t, e, i) {
        i = i || this;
        for (var n = 0, a = t.length; a > n; n++) "undefined" != typeof t[n] && e.call(i, t[n], n, t)
    }
    ...
    function r(t) {
        for (t = t.replace(Q, "/"), t = t.replace(z, "$1/"); t.match(j);) t = t.replace(j, "/");
        return t
    }
    ...
    function p(t) {
        var e, i = q.paths;
        return i && (e = t.match(G)) && O(i[e[1]]) && (t = i[e[1]] + e[2]), t
    }

    function d(t) {
        var e = q.vars;
        return e && t.indexOf("{") > -1 && (t = t.replace(V, function (t, i) {
            return O(e[i]) ? e[i] : t
        })), t
    }
    ...
    function u(t) {
        var e = q.map, i = t;
        if (e) for (var n = 0, a = e.length; a > n; n++) {
            var o = e[n];
            if (i = B(o) ? o(t) || t : t.replace(o[0], o[1]), i !== t) break
        }
        return i
    }
    ...
    function h(t, e) {
        var i, n = t.charAt(0);
        if (K.test(t)) i = t; else if ("." === n) i = r((e ? o(e) : q.cwd) + t); else if ("/" === n) {
            var a = q.cwd.match(Y);
    ...
    function m(t, e, i) {
        var n = ot.test(t), a = J.createElement(n ? "link" : "script");
        if (i) {
            var o = B(i) ? i(t) : i;
            o && (a.charset = o)
        }
    ...
    function b(t, e, i, n) {
        function a() {
            t.onload = t.onerror = t.onreadystatechange = null, i || q.debug || nt.removeChild(t), t = null, e()
        }

        var o = "onload" in t;
        return !i || !rt && o ? void (o ? (t.onload = a, t.onerror = function () {
            U("error", {uri: n, node: t}), a()
    ...
    function x(t, e) {
        var i, n = t.sheet;
        if (rt) n && (i = !0); else if (n) try {
            n.cssRules && (i = !0)
        } catch (a) {
            "NS_ERROR_DOM_SECURITY_ERR" === a.name && (i = !0)
        }
        setTimeout(function () {
            i ? e() : x(t, e)
        }, 20)
    ...
    function v() {
        if (et) return et;
        if (it && "interactive" === it.readyState) return it;
        for (var t = nt.getElementsByTagName("script"), e = t.length - 1; e >= 0; e--) {
            var i = t[e];
            if ("interactive" === i.readyState) return it = i
        }
    }

    function _(t) {
        var e = pt.exec(t), i = st;
        e && "require" !== (e = e[1]) && (i = i.toString().replace(/require/g, e), i = i.slice(1, i.length - 2), i = new RegExp(i, "g"));
        var n = [];
        return t.replace(ct, "").replace(i, function (t, e, i) {
            i && n.push(i)
        }), n
    }
    ...
    function E(t) {
        q.combo && (t.requestUri = _t[t.uri] || t.uri)
    }

    function k(t) {
        var e = [], i = Et.exec(t[0])[1], n = i.length;
        a(t, function (t) {
            e.push(t.substr(n))
        }), T(i, e)
    }
    ...
    function T(t, e) {
        ...
        if (e.length > 1 && r) {
            ...
            if (r) throw new Error("The combo url is too long: " + o);
            for (var n = 0, a = e.length; a > n; n++) _t[t + e[n]] = o
        }
    }

    function I(t, e) {
        for (var i = wt[1], n = t[0], a = 1, o = t.length; o > a; a++) if (n += i + t[a], n.length > e) return [t.splice(0, a), t]
    }
    ...
    function S(t) {
        return bt ? bt.test ? bt.test(t) : bt(t) : void 0
    }

    function C(t) {
        var e = q.comboSyntax || wt, i = e[0], n = e[1];
        return i && t.indexOf(i) > 0 || n && t.indexOf(n) > 0
    }

    if (t.LBF) var P = t.LBF;
    var exports = t.LBF = {version: "0.8.0"}, q = exports.data = {};
    exports.noConflict = function () {
        P && (t.LBF = P)
    };
    var L = i("Object"), O = i("String"), N = Array.isArray || i("Array"), B = i("Function"), M = i("Number"),
        W = i("RegExp"), R = 0, F = q.events = {};
    exports.on = function (t, e) {
        var i = F[t] || (F[t] = []);
        return i.push(e), exports
    }, exports.off = function (t, e) {
        if (!t && !e) return F = q.events = {}, exports;
        var i = F[t];
        if (i) if (e) for (var n = i.length - 1; n >= 0; n--) i[n] === e && i.splice(n, 1); else delete F[t];
        return exports
    };
    var U = exports.emit = function (t, e) {
            var i = F[t];
            if (i) {
                i = i.slice();
                for (var n = 0, a = i.length; a > n; n++) i[n](e)
            }
            return exports
        }, D = /[^?#]*\//, Q = /\/\.\//g, j = /\/[^\/]+\/\.\.\//, z = /([^:\/])\/+\//g, G = /^([^\/:]+)(\/.+)$/,
        V = /{([^{]+)}/g, H = /^[\w-_]*(?:\.[\w-_]+)*(\?[\w-_&=]*)?$/, K = /^\/\/.|:\//, Y = /^.*?\/\/.*?\//,
        J = document, X = location.href && 0 !== location.href.indexOf("about:") ? o(location.href) : "", $ = J.scripts,
        Z = J.getElementById("LBFnode") || $[$.length - 1], tt = o(g(Z) || X);
    exports.resolve = f;
    var et, it, nt = J.head || J.getElementsByTagName("head")[0] || J.documentElement,
        at = nt.getElementsByTagName("base")[0], ot = /\.css(?:\?|$)/i,
        rt = +navigator.userAgent.replace(/.*(?:AppleWebKit|AndroidWebKit)\/(\d+).*/, "$1") < 536;
    exports.request = m;
    var lt,
        st = /"(?:\\"|[^"])*"|'(?:\\'|[^'])*'|\/\*[\S\s]*?\*\/|\/(?:\\\/|[^\/\r\n])+\/(?=[^\/])|\/\/.*|\.\s*require|(?:^|[^$])\brequire\s*\(\s*(["'])(.+?)\1\s*\)/g,
        ct = /\\\\/g, pt = /^function[\s]*\([\s]*([^\f\n\r\t\v,\)]+)/, dt = exports.cache = {}, ut = {}, ht = {},
        ft = {}, gt = w.STATUS = {FETCHING: 1, SAVED: 2, LOADING: 3, LOADED: 4, EXECUTING: 5, EXECUTED: 6};
    w.prototype.resolve = function () {
        for (var t = this, e = t.dependencies, i = [], n = 0, a = e.length; a > n; n++) i[n] = w.resolve(e[n], t.uri);
        return i
        ...
        function e() {
            exports.request(o.requestUri, o.onRequest, o.charset)
        }

        function i() {
            delete ut[r], ht[r] = !0, lt && (w.save(a, lt), lt = null);
            var t, e = ft[r];
            for (delete ft[r]; t = e.shift();) t.load()
        }
        ...
        return !r || ht[r] ? void n.load() : ut[r] ? void ft[r].push(n) : (ut[r] = !0, ft[r] = [n], U("request", o = {
            uri: a,
            requestUri: r,
            onRequest: i,
            charset: q.charset
        ...
        function require(t) {
            return w.get(require.resolve(t)).exec()
        }
        ...
        var i = t.uri;
        require.resolve = function (t) {
            return w.resolve(t, i)
        }, require.async = function (t, e) {
            return w.use(t, e, i + "_async_" + n()), require
        };
        var a = t.factory, exports = B(a) ? a(require, t.exports = {}, t) : a;
        ...
        var i = {id: t, refUri: e};
        return U("resolve", i), i.uri || exports.resolve(i.id, e)
    }, w.define = function (t, i, n) {
        ...
        return dt[t] || (dt[t] = new w(t, e))
    }, w.use = function (e, i, n) {
    ...
    }, exports.use = function (t, e) {
        return w.use(t, e, q.cwd + "_use_" + n()), exports
    }, w.define.cmd = {}, exports.define = w.define, exports.Module = w, q.fetchedList = ht, q.cid = n, exports.require = function (t) {
        var e = w.get(w.resolve(t));
        return e.status < gt.EXECUTING && (e.onload(), e.exec()), e.exports
    }, q.base = tt, q.dir = tt, q.cwd = X, q.charset = "utf-8", exports.config = function (t) {
        for (var e in t) {
            var i = t[e], n = q[e];
            if (n && L(n)) for (var a in i) n[a] = i[a]; else N(n) ? i = n.concat(i) : "base" === e && ("/" !== i.slice(-1) && (i += "/"), i = h(i)), q[e] = i
        }
        return U("config", t), exports
    };
    var mt = [["globalSettings", exports.data], ["lang.forEach", a], ["lang.isType", i], ["lang.isObject", L], ["lang.isString", O], ["lang.isArray", N], ["lang.isFunction", B], ["lang.isNumber", M], ["lang.isRegExp", W], ["util.request", m]];
    t.JSON && mt.push(["lang.JSON", t.JSON]), t.jQuery && 0 === (t.jQuery.version || "").indexOf("1.7") && mt.push(["lib.jQuery", t.jQuery]), a(mt, function (t) {
        exports.define(t[0], function (require, exports, module) {
            module.exports = t[1]
        })
    });
    var bt, xt, w = LBF.Module, vt = w.STATUS.FETCHING, q = LBF.data, _t = q.comboHash = {}, wt = ["c/=/", ",/"],
        yt = 1e3;
    ...
    var t = require("lang.forEach"), e = require("lang.extend"), i = require("lang.isFunction"),
        n = require("util.Event"), a = require("wpa.proto.main"), o = require("wpa.api"), r = require("wpa.bus");
    ...
    module.exports = exports = __WPA, window.__QDWPABUS || (window.__QDWPABUS = {}), e(__QDWPABUS, n), r.init(), exports.init = function () {
        var e = exports, i = e._evtBkt;
        for (var n in i) i.hasOwnProperty(n) && t(i[n], function (t) {
            e.on(n, t)
        });
        delete e._evtBkt;
        var a = e._stack;
        t(a, function (t) {
            t && e.create(t)
        }), delete e._stack, e.trigger("load")
    }, exports.ready = function (t) {
        i(t) && t()
    }, exports.create = function (t) {
        try {
            t._sTime = +new Date, new a(t)
        } catch (e) {
    ...
    module.exports = function (e, i, n) {
        ...
        function o(e, i) {
            for (var n in i) i.hasOwnProperty(n) && (t(i[n]) ? (e[n] = e[n] || {}, o(e[n], i[n])) : e[n] = i[n])
        }

        var r = [].slice.apply(arguments), l = r.shift(), s = a;
        "boolean" == typeof l && (l = r.shift(), l && (s = o));
        for (var c = 0, p = r.length; p > c; c++) s(l, r[c]);
        return l
    }
}), LBF.define("util.Event", function (require, exports) {
    var t = require("lang.toArray"), e = require("util.Callbacks"), i = "_EVENTS";
    exports.on = function (t, n, a) {
        ...
        if (1 === a) {
            var l = n, s = this;
            n = function () {
                return s.off(t, n), l.apply(this, arguments)
            }
        }
        return r.add(n), this
    }, exports.off = function (t, e) {
        if (!t) return this[i] = {}, this;
        var n = this[i];
        return n && n[t] ? e ? (n[t].remove(e), this) : (n[t].empty(), this) : this
    }, exports.trigger = function () {
        var e = t(arguments), n = e.shift(), a = this[i];
        return a && a[n] ? (a[n].fireWith(this, e), this) : this
    }, exports.once = function (t, e) {
        return this.on(t, e, 1)
    }
}), LBF.define("wpa.proto.main", function (require, exports, module) {
    var t = require("lang.extend"), e = require("util.Event"), i = require("wpa.proto.render"),
        n = require("wpa.proto.uiEvents"), a = (require("util.GUID"), require("util.localStorage")),
        o = (require("wpa.protocol.kfuin"), require("wpa.proto.custom")), r = require("wpa.conf.config"), l = r.KFUINS,
        s = r.WEB_IM, c = s.WPAS_IM_TYPE, p = r.gWin, d = (require("lang.browser"), r.isMobile, r.GLOBAL_WPA),
        u = r.WPAS_BASED_ON_KFUIN, h = require("wpa.protocol.Reporter"),
        f = (require("wpa.proto.basicCgiCall"), require("wpa.util.getRootDomain")), g = require("wpa.util.ids"),
        m = (require("wpa.util.log"), require("util.Cookie")), b = require("wpa.proto.chat"),
        x = require("wpa.proto.phone"), v = require("wpa.proto.add"), _ = require("wpa.proto.im"),
        w = require("wpa.im.init"), y = require("wpa.invite.main"), E = require("wpa.proto.socket"),
        k = require("wpa.proto.getGdtClickId"), T = require("wpa.proto.UnreadMsgCircle"),
        I = require("wpa.proto.pvReport"), A = r.sandbox, S = A.Object, C = require("wpa.proto.addDa");
    p[d] = p[d] ? p[d] : new S, p.__WPA[l] = "undefined" != typeof p.__WPA[l] ? p.__WPA[l] : new S, p.__WPA[u] = "undefined" != typeof p.__WPA[u] ? p.__WPA[u] : new S, p.__WPA[c] = "undefined" != typeof p.__WPA[c] ? p.__WPA[c] : new S, module.exports = exports = function (t) {
        this.initialize(t)
    };
    var P = exports.prototype;
    p.__WPA.IM = _;
    var q = function () {
        return A.Math.round(2147483647 * (A.Math.random() || .5)) * +new A.Date % 1e10
    }, L = function () {
        var t = window.__qq_qidian_da_pid;
        return t && /^QD\./.test(t) || (t = window.__qq_qidian_da_pid = g.createPid(!0)), t
    }, O = function () {
        var t = f.getRootDomain(), e = f.isCookieEnabled, i = "";
        ...
        }), this.on("gdtReport", function (t) {
            h.report(t.reportType, t)
        }), this.on("initIm", function () {
            var t = this.params, e = t.fkfuin;
            t.cate;
        ...
        var e = t.cate, i = t.type;
        return 1 == e && (17 == i || 18 == i) || 7 == e && (15 == i || 16 == i) ? !0 : void 0
    };
    P.initialize = function (t) {
        var e = this, i = t.fkfuin;
        if (e.env = new S, p.__WPA[l][i] || (p.__WPA[l][i] = {
            unread: {
                chat: 0,
                socket: 0
            }
        }), a.getItem(r.tencentSig)) t.guid = a.getItem(r.tencentSig); else {
            var n = q();
            t.guid = n, a.setItem(r.tencentSig, n)
        }
        p.__WPA.visitorId = t.guid, t.wpa = this, this.params = t;
        var o = this.params.pid = L().substring(3), s = this.params.qid = O().substring(3);
    ...
    var t = exports.api = {}, e = require("wpa.proto.main"), i = require("wpa.protocol.chat"),
        n = require("wpa.invite.inviteApi");
    t.create = function (t) {
        return new e(t)
    }, t.createCustom = function (t) {
        return new e(t)
    }, t.chat = function (t) {
    }, t.PCChat = function (t, e) {
        i.PCChat(t, e)
    }, t.mobileChat = function (t, e) {
        i.mobileChat(t, e)
    }, t.anonyChat = function (t, e) {
        i.anonyChat(t, e)
    }, t.linkChat = function (t, e) {
        i.linkChat(t, e)
    }, t.invite = function (t) {
        n.trigger(t)
    }
}), LBF.define("wpa.bus", function (require, exports, module) {
    var t = require("wpa.util.badjs").badjsReport, e = !1, i = .9;
    exports.init = function () {
        e || (e = !0, __QDWPABUS.on("error", function (e) {
            Math.random() > i && t(e)
        }))
    }, exports.triggerError = function (t) {
        window.__QDWPABUS && __QDWPABUS.trigger("error", t)
    }
}), LBF.define("lang.isPlainObject", function (require, exports, module) {
    var t = require("lang.isObject"), e = function (t) {
        return t && t === t.window
    };
    module.exports = function (i) {
        if (!i || !t(i) || i.nodeType || e(i)) return !1;
        var n = Object.prototype.hasOwnProperty;
        try {
            if (i.constructor && !n.call(i, "constructor") && !n.call(i.constructor.prototype, "isPrototypeOf")) return !1
        } catch (a) {
            return !1
        }
        var o;
        for (o in i) ;
        return void 0 === o || n.call(i, o)
    }
    ...
    var t = (require("lang.Class"), require("lang.forEach")), e = require("lang.extend"),
        i = require("lang.isFunction"), n = require("lang.isString"), a = require("lang.inArray"), o = /\S+/g, r = {},
        l = function (e) {
            var i = r[e] = {};
            return t(e.match(o) || [], function (t) {
                i[t] = !0
            }), i
        };
    module.exports = function (o) {
        o = "string" == typeof o ? r[o] || l(o) : e({}, o);
        var s, c, p, d, u, h, f = [], g = !o.once && [], m = function (t) {
            for (c = o.memory && t, p = !0, u = h || 0, h = 0, d = f.length, s = !0; f && d > u; u++) if (f[u].apply(t[0], t[1]) === !1 && o.stopOnFalse) {
                c = !1;
                break
            }
            ...
            add: function () {
                if (f) {
                    ...
                    !function a(e) {
                        t(e, function (t) {
                            i(t) ? o.unique && b.has(t) || f.push(t) : t && t.length && n(t) && a(t)
                        })
                    }(arguments), s ? d = f.length : c && (h = e, m(c))
                }
                return this
            }, remove: function () {
                return f && t(arguments, function (t) {
                    for (var e; (e = a(t, f, e)) > -1;) f.splice(e, 1), s && (d >= e && d--, u >= e && u--)
                }), this
            }, has: function (t) {
                return t ? a(t, f) > -1 : !(!f || !f.length)
            }, empty: function () {
                return f = [], d = 0, this
            }, disable: function () {
                return f = g = c = void 0, this
            }, disabled: function () {
                return !f
            }, lock: function () {
                return g = void 0, c || b.disable(), this
            }, locked: function () {
                return !g
            }, fireWith: function (t, e) {
                return !f || p && !g || (e = e || [], e = [t, e.slice ? e.slice() : e], s ? g.push(e) : m(e)), this
            }, fire: function () {
    ...
    var t = require("wpa.util.onIframeLoaded"), e = require("wpa.util.tmplCompiler"), i = require("wpa.util.Style"),
        n = require("lang.extend"), a = require("wpa.conf.wpaType"), o = require("wpa.util.insertIframe"),
        r = require("wpa.conf.floatCss"),
        l = (require("wpa.conf.Events"), require("lang.proxy"), require("wpa.conf.wpaTmpl")),
        s = require("lang.inArray"), c = (require("wpa.util.domEvent"), require("wpa.conf.defaultConst")),
        p = require("wpa.util.getSize"), d = require("wpa.conf.config"), u = require("wpa.util.bindLogicEvents"),
        h = require("wpa.util.htReport"), f = require("lang.browser"), g = "box-shadow:0 1px 15px rgba(0, 0, 0, 0.15);",
        m = "border-top: 1px solid #e3e3e3;border-bottom:1px solid #e3e3e3;", b = "border-radius: {borderRadius};",
        x = "middle", v = function (c, v) {
            l.init({ratio: c.ratio});
            var _ = p(c.ratio), w = c.cate, y = c.type, E = c.theme, k = v, T = c.container, I = (c.ratio, c.scene),
                A = c.fkfuin, S = c.key, C = c.position, P = l.get(w, y), q = a[w][y], L = q.borderRadius,
                O = q.hasBoxShadow, N = q.iframeBorder, B = q.floatStyle, M = s("position", q.htmlRequired || []), W = "",
                R = q.isPC, F = q.isInQQ, U = P.cssText, D = R ? P.width : _(P.width), Q = R ? P.height : _(P.height),
                j = "undefined" != typeof c.enableFloat ? c.enableFloat : !0;
            if (!j || void 0 == c.position && void 0 == P.defaultPosition && "object" != typeof c.location || (W = r.getFloatStyle({
                width: D,
                height: Q,
                floatStyle: B,
                position: c.position,
            ...
            var V = d.WPA_ID_PREFIX + A + "_" + c.id, H = "class_qidian_wpa",
            ...
            var Y;
            try {
                Y = document.createElement(K)
            } catch (J) {
                Y = document.createElement("iframe"), Y.width = D, Y.height = Q, Y.id = V, Y.style.cssText = W, Y.setAttribute("scrolling", "no"), Y.setAttribute("frameborder", 0), Y.setAttribute("allowtransparency", !0), Y.setAttribute("src", "about:blank"), Y.setAttribute("class", H)
            }
            ...
            if (f.msie) try {
                ...
                Y.src = "javascript:void((function(){document.open();document.domain='" + document.domain + "';document.close()})())"
            }
            var Z = function () {
                var t = Y.contentWindow, e = Y.contentDocument || t.document;
                if (e.open(), e.write(["<!doctype html>", '<html xmlns="http://www.w3.org/1999/xhtml">', "<head>", '<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />', f.msie && "about:blank" !== Y.src ? "<script>document.domain='" + document.domain + "';</script>" : "", "</head>", "<body>", $, "</body>", "</html>"].join("")), e.close(), f.isIOS || f.isAndroid) try {
                ...
                u(r, v), __WPA.trigger("inited", k.params), h(c._sTime, 31), setTimeout(function () {
                    v.trigger("render", n({reportType: "render"}, c))
                }, 1e3)
            };
            return t(Y, Z), Y
        }, _ = function (t) {
    ...
    exports.render = function () {
        _(this.params), this.el = v(this.params, this)
    ...
    function t(t) {
        t.reportType = "click", t.wpa.trigger("click", t), setTimeout(function () {
            t.wpa.trigger("gdtReport", e({reportType: "gdtReport"}, r._gdtReportData))
        }, 120)
    }

    var e = require("lang.extend"), i = require("wpa.conf.config"), n = i.TP_FORM, a = i.CLICK_TYPE, o = i.ROLE_KEY,
        r = (i.isInAdmin, i.gWin), l = require("wpa.util.ids"), s = 1, c = 2, p = 3, d = function (t) {
            var e = t.roleKey || o.QQ, a = t[e] || t[o.QQ] || {};
            ...
            var e = !0;
            return t.id || (e = !1, alert("此处只提供样式预览，不支持功能预览")), e
        };
    exports.defaultEventType = "click", exports.callClose = function () {
        ...
        try {
            this.params.roleKey = o.PUB, d(this.params), this.params.clickType = a.PUB, t(this.params), __WPA.trigger("clicked", this.params), this.addFan()
        } catch (e) {
            __QDWPABUS.trigger("error", e)
        }
        !u(this.params)
        ...
        try {
            this.params.roleKey = o.IM, d(this.params), this.params.clickType = a.IM, t(this.params), __WPA.trigger("clicked", this.params), this.im(e({isClickWpa: !0}, this.params))
        } catch (i) {
            __QDWPABUS.trigger("error", i)
        }
        !u(this.params)
    }
    ...
    var t = require("util.Cookie"), e = require("lang.trim"), i = !0;
    try {
        var n = window.localStorage;
        n.setItem("lstest", 1)
    } catch (a) {
        i = !1, window.localStorage && (window.localStorage.setItem = function () {
        })
    }
    var o = "IELS", r = 31536e8, l = document, s = new RegExp("(?:^|[ ;])" + o + "[^=]+=([^;$])"), c = function (t) {
        return o + t
    }, p = function (t) {
        var e, i = l.cookie.split(";"), n = 0, a = i.length, o = [];
        if (t) for (; a > n; n++) (e = s.exec(i[n])) && (o.push(e[1]), t(e[1])); else for (; a > n; n++) (e = s.exec(i[n])) && o.push(e[1]);
        return o
    };
    return i ? window.localStorage : {
        length: p().length, key: function (t) {
            return p()[t] || null
        }, getItem: function (e) {
            return t.get(c(e))
        }, setItem: function (e, i) {
            t.set(c(e), i, null, "/", r), this.length = p().length
        }, removeItem: function (e) {
            t.del(e), this.length = p().length
        }, clear: function () {
            this.length = p(function (i) {
                t.del(e(i.split("=")[0]))
            }).length
        }
    }
    ...
    var e = require("util.jsonp"), i = require("wpa.conf.chat"), n = require("lang.isFunction"),
        a = i.WPL_B_QQ_COM_CONV, o = {};
    return {
        get: function (i, r) {
    ...
    var t = require("util.domEvent"), e = require("wpa.conf.config"),
        i = (require("wpa.util.log"), require("wpa.util.offset")), n = require("wpa.util.htReport"), a = e.gWin,
        o = a.document, r = o.body, l = require("lang.extend"), s = (require("wpa.protocol.Reporter"), {
            callChat: "callChat",
            callPhone: "callPhone",
            ...
            var e, n = t.zoom, a = t.width, o = t.height, r = t.h || {}, l = t.v || {}, s = r.type, c = r.px, p = l.type,
                d = l.px, u = ["position:fixed", "cursor:pointer", "z-index:1999999999"];
            if (0 == n) 1 == s ? u.push("left:" + c + "px") : 2 == s ? (u.push("left:50%"), u.push("margin-left:-" + a / 2 + "px")) : u.push("right:" + c + "px"), 1 == p ? u.push("top:" + d + "px") : 2 == p ? (u.push("top:50%"), u.push("margin-top:-" + o / 2 + "px")) : u.push("bottom:" + d + "px"), u.push("width:" + a + "px"), u.push("height:" + o + "px"); else if (1 == n) u.push("width:100%"), u.push("left:0"), e = i.getClientWidth() / a, o *= e, u.push("height:" + o + "px"), 1 == p ? u.push("top:" + d + "px") : 2 == p ? (u.push("top:50%"), u.push("margin-top:-" + o / 2 + "px")) : u.push("bottom:" + d + "px"); else {
            ...
            var s, c = i.fkfuin, d = i.id, u = (e.CUSTOM_IMG_ID_PREFIX + c + "_" + d, e.CUSTOM_IMG_CLASS_NAME),
                h = i.custom.customImg, f = (h.zoom, h.url), g = p(h), m = i.imgParentDomId,
                b = '<img src="' + f + '" class="' + u + '" style="' + g + '" />';
            try {
                s = document.createElement(b)
            } catch (x) {
                s = document.createElement("img"), s.style.cssText = g, s.setAttribute("src", f), s.setAttribute("class", u)
            }
            s.onload = function () {
                t.addEvent(s, "click", function () {
                    l[a] && l[a]()
                }), n(l.params._sTime, 33)
            }, m ? o.getElementById(m).appendChild(s) : r.appendChild(s)
        }, u = function (e, i, a) {
            var r = "";
            if ("string" == typeof e && (0 === e.indexOf("#") && (e = e.substring(1)), r = e, e = o.getElementById(e)), !e) {
                var l = "[Custom DOM id not exist]dom id:" + r;
                throw l
            }
            t.addEvent(e, "click", function () {
                a[i] && a[i]()
            }), n(a.params._sTime, 32)
        };
    exports.custom = function (t) {
        var e = this, i = s.callChat, n = t.custom || {}, a = n.customType;
        if (t.cate == config.TYPES.IM && (i = s.callIm), a == c) d(t, i, e); else {
            var o = n.domId;
            u(o, i, e)
        }
    ...
    function t() {
        var t = window;
        return -1 !== location.href.indexOf("qdconnect.html") && -1 !== location.search.indexOf("wp.qiye.qq.com") && (t = r ? top : parent, h = !0), t
    }

    var e = require("globalSettings"), i = e.staticBase, n = e.base, a = e.protocol, o = require("lang.browser"),
        r = o.isAndroid || o.isIOS, l = -1 !== location.hostname.indexOf("local.qiye.qq.com"),
        s = -1 !== location.protocol.indexOf("https"), c = "admin.qidian.qq.com",
        p = {common: c + "/tp/wpaCall/getProtocol", mp: c + "/tp/wpaCall/getMpProtocol"},
        d = c + "/qbf/aBTest/getGrayLevel", u = t(), h = !1, f = u, g = f.document, m = g.body,
        b = navigator.userAgent.toLowerCase(),
        x = -1 !== f.location.href.indexOf("admin.qidian.qq.com/tp/wpa") ? !0 : !1, v = /\bQQ\/([\d\.]+)/i,
        _ = /\bIPadQQ\/([\d\.]+).*?\bQQ\/([\d\.]+)/i, w = /\bV1_AND_SQI?_([\d\.]+)(.*? QQ\/([\d\.]+))?/i,
    ...
    var S = "http://local.qiye.qq.com/mockup/socket.html", C = "http://local.qiye.qq.com/mockup/status_socket.html",
    ...
    r || (P = L, q = O), l && (q = S);
    var B = 8;
    if (b.indexOf("msie") > -1) var M = b.match(/msie\s\d+/), W = M && M[0].match(/\d+/), B = W ? Number(W) : B;
    module.exports = {
        imageBaseUrl: i + "/images",
        customBaseUrl: n,
        isSSL: s,
        tencentSig: "tencentSig",
        cgiDomain: "https://" + T + "admin.qidian.qq.com",
        CGIS: {
            GET_SIGT: {
                development: a + "//dev" + p.common,
                test: a + "//oa" + p.common,
                production: a + "//" + p.common
            },
            GET_MP_SIGT: {development: a + "//dev" + p.mp, test: a + "//oa" + p.mp, production: a + "//" + p.mp},
            GET_SCALE_INFO: {development: a + "//dev" + d, test: a + "//oa" + d, production: a + "//" + d},
            GET_QQ_INVITE_SIGT: "https://" + T + "admin.qidian.qq.com/webim/commonRequest/getProtocol",
            CLOSE_INVITE_REPORT: "https://" + T + "admin.qidian.qq.com/webim/commonRequest/winClose"
        },
        PAGES: {VOICE_JUMP_PAGE: "https://" + T + "lbs.qidian.qq.com/authorize/voiceShow"},
        host: c,
        ENV: "undefined" != typeof __WPAENV ? __WPAENV : "production",
        TYPES: {QQ: 1, PHONE: 2, PUB: 3, GROUP: 4, KFEXT: 5, IM: 7},
        ...
        INVITATION_TYPE: {OFFLINE: 3, AUTO: 4},
        ...
        WEB_IM: {
            ...
            LAUNCH_TYPES: {QQ: "QQ", PHONE: "PHONE"}
        },
        isMobile: r,
        isLocal: l,
        isDev: I,
        ...
        winWidth: m.offsetWidth,
        winHeight: m.offsetHeight,
        ...
        ROLE_KEY: {QQ: "roleQQ", TEL: "roleTEL", KFEXT: "roleKFEXT", GROUP: "roleGROUP", PUB: "rolePUB", IM: "roleIM"},
        CLICK_TYPE: {QQ: 1, TEL: 2, KFEXT: 5, GROUP: 4, PUB: 3, IM: 6},
        TP_FORM: {ICON: 1, LINK: 2, QR: 3},
        SANDBOX_ID: "__QIDIAN_SANDBOX",
        sandbox: f,
        IM_ORIGIN: "webpage.qidian.qq.com",
        IM_ORIGIN_REG: l ? /^http(s)?:\/\/local.qiye.qq.com(\/)?$/ : /^http(s)?:\/\/(dev|oa)?webpage.qidian.qq.com(\/)?$/,
        badjs: {id: 1367, random: 1},
        POST_MESSAGE_FLAG: "QD_PM",
        POST_MESSAGE_FLAG_CONTENT: "WPA",
        IM_LANG: {key: "qidian_lang", defaultLang: "zh-cn", availableList: ["zh-cn", "en-us"]}
    }
    ...
    i.indexOf("trident") > -1 && (e = /rv:([\d.]+)/.exec(i)) && (n[1] = "msie",
        ...
        browser: n[1] || "",
        version: n[2] || "0"
    }, t.browser && (exports[t.browser] = !0, exports.version = t.version), exports.chrome ? exports.webkit = !0 : exports.webkit && (exports.safari = !0);
    var a = exports.msie, o = parseInt(exports.version, 10),
    ...
    var t = (require("wpa.conf.report"), require("lang.JSON"), require("wpa.util.removeCustomProperty"), require("wpa.util.formReport")),
        e = require("wpa.conf.config"), i = e.gWin, n = e.ENV, a = (require("util.jsonp"), require("lang.browser")),
        o = require("lang.extend"), r = require("globalSettings"), l = require("wpa.proto.getCPType"),
        s = {development: "devadmin.", test: "oaadmin.", production: "admin."}, c = s[r.debug] || "",
        p = "https://" + c + "qidian.qq.com",
        d = {render: "/ar/ActCap/ActRpt", click: "/ar/ActCap/ActRpt", gdtReport: "/ar/actCap/gdtRpt"}, u = 1, h = 2,
        f = "gdtReport", g = location.hostname, m = function () {
            var t = {}, e = ["post.mp.qq.com", "article.mp.qq.com", "mp.weixin.qq.com", "wap.qidian.qq.com"].join(",");
            if (-1 !== e.indexOf(g)) {
            ...
            var u = {
                ...
                kfuin: r.fkfuin,
                kfext: c,
                ldpg: i.location.href,
                refurl: "undefined" != typeof document.referrer ? document.referrer : "",
                ua: window.navigator.userAgent,
                title: encodeURIComponent(document.title),
                eptype: a.isMobile ? 2 : 1,
                pid: r.pid,
                qid: r.qid,
                env: n,
                isKfuin: r.roleQQ && r.roleQQ.isKfuin || 0
            };
            if (1 == r.customEnterSwitch && (u.qidian_src_desc = encodeURIComponent(i.qidian_src_desc) || "", u.qidian_track_id = i.qidian_track_id || ""), o(u, m()), "render" === e) dataObj = x(r, u); else {
                if ("click" !== e) return;
                var g = l(r);
                r.tptype = g.tptype, dataObj = o({
                    eventtp: h,
    ...
    var i = require("wpa.conf.config"), n = i.gWin, a = i.CGIS, o = i.ENV, r = n.__WPA,
        l = (i.WPAS_BASED_ON_KFUIN, require("wpa.util.log")),
        s = (require("wpa.util.removeCustomProperty"), require("util.jsonp")), c = 1e3, p = 1;
    r.cgiCalls = {}, r.imUrls = {}, r.cgiCalls.getScaleInfo = exports.getScaleInfo = function (n, r) {
        n = n || {};
        var p = !1, d = {result: 0}, u = n.kfuin, h = a.GET_SCALE_INFO[o], f = null, g = function (n) {
        ...
        var m = {kfuin: u};
        s(h, m, g), f = setTimeout(function () {
            l("[getScaleInfo]setTimeout executed"), g(d)
        }, c)
    }
}), LBF.define("wpa.util.getRootDomain", function (require, exports, module) {
    var t, e = require("util.Cookie"), i = require("wpa.conf.config"), n = i.gWin, a = require("lang.inArray"),
        o = (n.document, n.location.hostname), r = (o.length, o.split(".")), l = r.length, s = "", c = 31536e6,
        p = "__root_domain_v", d = n.navigator.cookieEnabled, u = [".qq.com"], h = function () {
            for (var i = l - 1; i >= 0; i--) if (s = "." + r[i] + s, -1 === a(s, u) && (e.set(p, s, s, "/", c), e.get(p))) {
                t = s;
                break
            }
            return t
    ...
    var t = require("wpa.conf.config"), e = t.gWin, i = e.document, n = "QD.", a = function (t) {
    ...
    return {
        set: e ? function (e, i, n, a, o) {
            o && (o = new Date(+new Date + o));
            var r = e + "=" + escape(i) + (o ? "; expires=" + o.toGMTString() : "") + (a ? "; path=" + a : "") + (n ? "; domain=" + n : "");
            return r.length < 4096 && (t.cookie = r), this
        } : function () {
        }, get: e ? function (e) {
            var i = t.cookie.match(new RegExp("(^| )" + e + "=([^;]*)(;|$)"));
            return null != i ? unescape(i[2]) : null
        } : function () {
            return ""
        }, del: e ? function (e, i, n) {
            return this.get(e) && (t.cookie = e + "=" + (n ? "; path=" + n : "") + (i ? "; domain=" + i : "") + ";expires=Thu, 01-Jan-1970 00:00:01 GMT"), this
        } : function () {
        }, find: e ? function (e) {
            return t.cookie.match(e)
        } : function () {
        }
    }
}), LBF.define("wpa.proto.chat", function (require, exports, module) {
    var t = require("lang.browser"), e = require("wpa.protocol.chat"), i = require("wpa.conf.chat"),
        n = (require("wpa.protocol.getQQVersion"), require("wpa.proto.chatSelect"), require("lang.proxy")),
        a = require("wpa.conf.config"), o = require("util.report"), r = a.gWin, l = require("wpa.util.log"),
        s = r.location.href, c = require("wpa.util.parseQuerystring"),
        p = (require("wpa.util.openMqqPage"), "仅支持移动端咨询，请重新使用手机QQ发起咨询"), d = i.LAUNCH_MOBILE_QQ;
    exports.chat = function (u) {
        var h = n(function () {
                u && u.apply(this, arguments), this.trigger("chat")
            }, this), f = t.isIOS || t.isAndroid, g = this.params.onlyMobile,
            m = parseInt(this.params.chatType || i.CHAT_TYPE_AUTO, 10), b = this.params.fkfuin, x = this.params.guid,
            v = this.params.id, _ = this.params.pid, w = this.params.qid, y = this.params.key, E = this.params.clickid,
            k = this.params.roleValue, T = this.params.roleData, I = "";
        if ("development" == a.ENV ? I = "dev" : "test" == a.ENV && (I = "oa"), 1 != this.params.videoSwitch) {
            if (1 == this.params.customEnterSwitch) {
                var A = this.params.mediaId, S = "https://" + I + "lbs.qidian.qq.com/authorize/show";
                if (this.params.voice) return f ? (S = a.PAGES.VOICE_JUMP_PAGE, S += "?id=" + v + "&roleData=" + T + "&roleValue=" + k + "&key=" + y + "&qid=" + w + "&pid=" + _ + "&voice=1&clickid=" + E + "&mediaId=" + A + "&visitorId=" + x + "&kfuin=" + b + "&_bid=2399", r.location.href = d + "?mqqPage=" + S) : alert("暂不支持PC端打开");
                if (this.params.paramSwitch) {
                    S = "https://" + I + "lbs.qidian.qq.com/location/update";
                    var C = window.qidian_track_id || "", P = window.qidian_src_desc || "", q = window.qidian_ex1 || "",
                        L = window.qidian_ex2 || "", O = window.qidian_ex3 || "", N = window.qidian_ex4 || "",
                        B = window.qidian_ex5 || "", M = window.guestId || "",
            ...
            if (g && !f) {
                if (this.params.isPub) {
                    var F = a.host + "/template/blue/wpa/launch-qr-code.html?qrCodeImg=" + this.params.qrCodeImg;
                    return F = "development" === a.ENV ? "https://dev" + F : "test" === a.ENV ? "https://oa" + F : "https://" + F, window.open(F)
                }
                return alert(p)
            }
        ...
        if (f) {
            ...
            try {
                var D = s.match(/_appid=\d+/)[0].split("=")[1], Q = s.match(/code=[a-z0-9]+/i)[0].split("=")[1];
                U += "?appid=" + D + "&code=" + Q, o(U)
            } catch (j) {
                l("[chat.js][videoSwitch]get params error")
            }
        }
    }, exports.PCChat = function (t) {
        var i = this;
        e.PCChat(this.params, function () {
            t.apply(i, arguments), i.trigger("PCChat")
        })
    }, exports.mobileChat = function (t) {
        var i = this;
        e.mobileChat(this.params, function () {
            t.apply(i, arguments), i.trigger("mobileChat")
        })
    }, exports.anonyChat = function (t) {
        var i = this;
        e.anonyChat(this.params, function () {
            t.apply(i, arguments), i.trigger("anonyChat")
        })
    }, exports.linkChat = function (t) {
        var i = this;
        e.linkChat(this.params, function () {
            t.apply(i, arguments), i.trigger("linkChat")
        })
    }
    ...
    var t = require("lang.browser"),
        ...
        i = e.BROWSER_ENV.isInMobileQQ, n = e.gWin, a = (e.CGIS, t.isMobile), o = e.ENV,
    ...
    exports.phone = function (t) {
        ...
        return void setTimeout(function () {
            return i ? n.location.href = l : n.location.href = s
        }, 500)
    }
}), LBF.define("wpa.proto.add", function (require, exports, module) {
    var t = require("lang.browser"), e = require("util.jsonp"), i = require("wpa.conf.chat"),
        n = (require("lang.isFunction"), require("util.serialize")), a = require("wpa.conf.config"),
        o = (a.CLICK_TYPE, require("wpa.util.launch")), r = a.eptype,
        l = (require("wpa.util.removeCustomProperty"), a.gWin), s = a.CGIS, c = 0, p = 1, d = t.isMobile,
        u = a.BROWSER_ENV.isInMobileQQ, h = a.ENV, f = i.LAUNCH_MOBILE_QQ;
    navigator.userAgent.toLowerCase(), document.getElementsByTagName("body")[0];
    exports.addPal = function (i) {
        if (!t.isMobile && !(a.isOA || a.isDev || a.isLocal)) return alert("加好友仅限移动端呼起");
        var n = this.params, g = {
            kfuin: n.fkfuin,
            kfext: n.fkfext,
            visitorId: n.guid,
            ...
            eptype: r,
            tptype: n.tptype,
            clickType: n.clickType,
            roleKey: n.roleKey,
            roleValue: n.roleValue,
            roleUin: n.roleUin,
            roleData: n.roleData
        };
        e(s.GET_SIGT[h], g, function (t) {
            if (!t || 0 !== t.r || !t.data) return alert(t.data.message || ERROR_MSG_INVALID_STAFF);
            var e = t.data.sign;
            return u ? l.location.href = e : d ? l.location.href = f + "?kfuin=" + n.fkfuin + "&fid=" + n.id + "&key=" + n.key + "&protocol=" + e : o(e, {
                needMobileJump: !0,
                targetPage: f
            })
        })
        ...
        e(s.GET_SIGT[h], n, function (t) {
            if (!t || 0 !== t.r || !t.data) return alert(t.data.message || ERROR_MSG_INVALID_STAFF);
            var e = t.data.sign;
            return u ? l.location.href = e : d ? l.location.href = f + "?kfuin=" + i.fkfuin + "&fid=" + i.id + "&key=" + i.key + "&protocol=" + e : o(e, {
                needMobileJump: !0,
                targetPage: f
            })
        })
    }, exports.addFan = function (i) {
        if (!t.isMobile) return alert("加关注仅限移动端呼起");
        var a = this.params, o = {
            kfuin: a.fkfuin,
            kfext: a.fkfext,
            visitorId: a.guid,
        ...
        e(s.GET_SIGT[h], o, function (t) {
            if (!t || 0 !== t.r || !t.data) return alert(t.data.message || ERROR_MSG_INVALID_STAFF);
            var e = t.data.sign;
            return u ? l.location.href = e : l.location.href = f + "?" + n(o) + "&protocol=" + e
        })
    }
}), LBF.define("wpa.proto.im", function (require, exports, module) {
    var t, e = require("wpa.conf.config"), i = e.eptype, n = e.KFUINS, a = e.POST_MESSAGE_FLAG,
        o = e.POST_MESSAGE_FLAG_CONTENT, r = (e.CLICK_TYPE, e.isInAdmin), l = e.isMobile,
        s = require("util.localStorage"), c = e.INVITATION_TYPE, p = require("lang.extend"), d = e.WEB_IM.ACTS,
        u = e.SCROLL_TOP_NAME, h = e.WEB_IM, f = h.WEB_IM_IFRAME_ID,
        g = (h.WPAS_IM_TYPE, e.GLOBAL_WPA, e.UNREAD_MSG_INFO),
        m = (e.WEB_IM.POSITION_HELP_EL, e.GLOBAL_INVITE_TPL_AND_CONF), b = e.WEB_IM.WEB_IM_IFRAMES_LOADED,
        x = require("wpa.util.log"), v = require("wpa.util.offset"), _ = v.getClientWidth(), w = v.getClientHeight(),
        y = require("wpa.util.domEvent"), E = require("wpa.proto.UnreadMsgCircle"), k = require("wpa.invite.main"),
        T = require("wpa.util.ids"), I = (require("lang.browser"), require("wpa.proto.CustomParams")),
        A = require("lang.JSON"), S = require("wpa.im.lang"), C = e.IM_LANG.key, P = e.gWin, q = P.document, L = q.body,
        O = "QD_WPA_BODY_CLASS_NAME", N = "QD_WPA_STYLE_NODE", B = function (t) {
            t && "function" == typeof t.preventDefault && t.preventDefault()
        };
    P[u] = "undefined" != typeof P[u] ? P[u] : 0;
    var M = {
        mobile: {open: ["right:0;"].join(""), close: ["right:-3000px;"].join("")},
        pc: {
            open: ["right:10px", "bottom:10px", "width:360px", "height:530px", "border-bottom-left-radius:6px", "border-bottom-right-radius:6px", "display:block"].join(";") + ";",
            close: ["width:300px", "height:50px", "bottom:0"].join(";") + ";"
        }
    }, W = l ? M.mobile.open : M.pc.open, R = l ? M.mobile.close : M.pc.close, F = function (t) {
        var e = t.kfuin, i = q.getElementById(f + e);
        return {imIframe: i}
    };
    exports.openChatIframe = function (r) {
        r = r || {};
        var h, f = r.isClickWpa, _ = r.invitationType, w = r.seq, M = r.key, R = r.type, U = r.receptionUin,
            D = r.receptionName || "", Q = r.isDirectOpen, j = r.onlyOpen, z = r.isB2C,
            G = Q || j ? r : this.params || {}, V = G.fkfuin || G.kfuin || r.kfuin, H = F({kfuin: V}), K = H.imIframe,
            Y = G.id, J = G.guid, X = G.roleIM || G.roleQQ || {}, $ = X.value, Z = X.data, tt = G.key,
        ...
        if (f) var nt = this.params, at = {
            cate: nt.cate,
            type: nt.type,
            pid: nt.pid,
            qid: nt.qid,
            clickType: nt.clickType,
            tptype: nt.tptype,
            tpForm: nt.tpForm,
            eptype: i
        };
        ...
        if (Q) return h = {
            ...
            visitorid: it,
            act: d.OPEN
        }, P.wpaShowItemId && (h.wpaShowItemId = P.wpaShowItemId), h[a] = o, h[C] = S.getLang(), I.setCustomParams(h), h = A.stringify(h), void K.contentWindow.postMessage(h, "*");
        var st = P.__WPA[m][V], ct = st ? st.key : null, pt = {
            kfuin: V,
            wpaId: Y,
            visitorid: it,
            wpaKey: tt,
    ...
    var U = 1, D = 2, Q = 760, j = 640, z = function (t) {
        var e, i = t.imUrl, n = I.getCustomParams();
    ...
    exports.im = function (t) {
        var i = t.custom || {}, n = i.open || U;
        if (t.isCustom && n == D && !l) return z(t);
        this.env.isGray;
        return r || this.params.isImForbidden ? alert("网页接待类型接待组件暂不支持功能预览") : e.BROWSER_ENV.isIE && e.BROWSER_ENV.ieVersion < 8 ? alert("您的浏览器版本过低，请升级") : void this.openChatIframe(t)
    }, exports.set = function (t, i) {
        t === e.IM_LANG.key && S.setLang(i)
    }
    ...
    var e, i = (require("lang.browser"), require("wpa.conf.config")), n = i.POST_MESSAGE_FLAG,
        a = i.POST_MESSAGE_FLAG_CONTENT, o = i.BROWSER_ENV.isInMobileQQ, r = i.KFUINS, l = i.ROLE_KEY,
        s = i.WPAS_BASED_ON_KFUIN, c = require("wpa.util.offset"), p = require("wpa.util.onIframeLoaded"),
        d = i.isMobile, u = (i.GLOBAL_WPA, require("wpa.util.log")), h = require("lang.JSON"),
        f = require("wpa.util.launch"), g = require("wpa.util.domEvent"), h = require("lang.JSON"), m = i.gWin,
        b = m.document, x = b.body, v = m.__WPA, _ = (i.WEB_IM.POSITION_HELP_EL, c.getClientWidth()),
        w = c.getClientHeight(), y = i.WEB_IM.WEB_IM_IFRAME_ID, E = i.WEB_IM.WEB_IM_IFRAMES_OBJ_NAME,
        k = i.WEB_IM.WEB_IM_IFRAMES_LOADED, T = i.WEB_IM.ACTS,
        I = (i.WEB_IM.LAUNCH_TYPES, ["position:fixed;", "z-index:2000000010;"].join("")), A = 0,
    ...
    var L = exports.isImIframeLoaded = function (t) {
        return m[E][t] ? !0 : !1
    }, O = exports.initIframe = function (n) {
        n = n || {};
        var a = n.fkfuin, o = n.id, r = y + a, s = n.guid, u = (i.WEB_IM.URL, v.imUrls[a]), h = n[l.IM] || n[l.QQ],
            f = h.value, b = h.data,
        ...
        if (q[a] = q[a] ? q[a] : [], q[a].push(C), !L(a)) {
            ...
            var B,
                M = '<iframe scrolling="no" id="' + r + '" frameborder="0" width="100%" height="100%" allowtransparency="true" src="' + u + '" style="' + I + '"></iframe>';
            try {
                B = document.createElement(M)
            } catch (W) {
                B = document.createElement("iframe"), B.width = _, B.height = w, B.id = r, B.style.cssText = I, B.setAttribute("scrolling", "no"), B.setAttribute("frameborder", 0), B.setAttribute("allowtransparency", !0), B.setAttribute("src", u)
            }
            if (B._styles = {close: N}, x.appendChild(B), d) {
                var R;
                g.addEvent(m, "resize", function () {
                    clearTimeout(R), R = setTimeout(function () {
                        var t = c.getClientWidth(), e = (c.getClientHeight(), B.getAttribute("data-isOpen"));
                        0 == e && (B.style.cssText += "right:-" + 10 * t + "px;")
                    }, 300)
                })
            }
            m[E][a] = !0, p(B, function () {
                m[k][a] = !0, t(a, B), B.setAttribute("data-isOpen", "0")
            }, !0)
        }
        m[k][a] && t(a, B)
    }, N = function () {
        g.addEvent(m, "message", function (t) {
            if (t && t.data) {
                ...
                if ("string" == typeof n) try {
                    ...
                    u("JSON.parse error in initMessageListener"), u(a)
                }
                var l = Number(n.kfuin) || 0, c = (n.wpaId || 0, n.act),
                    p = (n.kfuin + "_" + n.wpaId, n.type || "", n.sign || ""), g = n.protocol || "", b = n.data || {};
                if (c === T.UNREAD) {
                ...
                } else if (c === T.CLOSE) v.IM.closeChatIframe({kfuin: l}); else if (c === T.LAUNCH) if (d) {
                    if (o && p) return m.location.href = p;
                    m.location.href = g
                } else f(g); else if (c === T.FOCUS) {
                    if (d) {
                        var w = b.adjust || 80, E = b.delay || 300;
                ...
                } else if (c === T.BLUR) d && clearTimeout(m.__qd_keyboard_interval); else if (c === T.OPEN) {
                    if (!d) {
                        var k = !0;
                        "undefined" != typeof v[r][l].onlyOpen && (k = v[r][l].onlyOpen), v[r][l].onlyOpen = void 0, v[r][l].unread.socket > 0 && (k = !1), v.IM.openChatIframe({
                            kfuin: l,
                            onlyOpen: k
                        })
                    }
                } else if (c === T.OPEN_IMG) {
                    var I = n.data && n.data.url;
                    if (!I) return u("[OPEN_IMG]imgUrl error");
                    d || m.open(I)
                } else if (c === T.SHOW && !d) {
                    var A = y + l, S = document.getElementById(A);
                    S && (S.style.cssText += "display:block;")
                }
            }
        })
    };
    exports.imInit = function (t, e) {
        t.isImForbidden || (v.isMsgListenerAdded || (N(), v.isMsgListenerAdded = !0), O(t), "function" == typeof e && e())
    }
}), LBF.define("wpa.invite.main", function (require, exports, module) {
    var t, e = require("wpa.invite.getInviteConf"), i = require("wpa.conf.config"), n = i.POST_MESSAGE_FLAG,
        a = i.POST_MESSAGE_FLAG_CONTENT, o = (i.SOCKET.ACTS, i.WEB_IM), r = i.WPAS_BASED_ON_KFUIN,
        l = i.INVITATION_TYPE, s = (o.WEB_IM_IFRAME_ID, o.WEB_IM_IFRAMES_OBJ_NAME), c = i.INVITE_IFRAME_ID_PREFIX,
        p = i.WEB_IM.WPAS_IM_TYPE, d = i.KFUIN_INVITED_TIMES, u = require("wpa.util.Style"),
        h = (require("wpa.util.offset"), require("lang.browser")), f = h.isAndroid || h.isIOS,
        g = require("lang.extend"), m = require("util.report"), b = require("wpa.util.launch"),
        x = require("wpa.invite.tpl"), v = require("wpa.util.ids"), _ = require("wpa.util.domEvent"),
        w = require("wpa.util.onIframeLoaded"), y = require("wpa.util.log"), E = require("util.jsonp"),
        k = require("util.serialize"), T = require("lang.JSON"), I = require("wpa.conf.chat"),
        A = require("wpa.proto.CustomParams"), S = i.SOCKET, C = S.ACTS, P = S.SOCKET_IFRAME_ID, q = I.LAUNCH_LINK,
        L = i.gWin, O = L.document, N = O.body, B = L.__WPA, M = {}, W = {}, R = i.GLOBAL_INVITE_TPL_AND_CONF;
    ...
    var F = exports.clearInvitePanel = function (t) {
        y(t);
        var e = t.kfuin, i = t.iframe || O.getElementById(c + e), n = t.$close, a = t.$btn1 || {}, o = t.$btn2 || {};
        n = a = o = null, M[e] = !1, i && i.parentNode && i.parentNode.removeChild(i)
    }, U = {
        qq: function (t) {
            var e = {
                kfuin: t.kfuin,
                isCorpUin: t.isCorpUin,
                clickId: v.createClickId(),
                visitorId: B.visitorId,
                ftype: i.isMobile ? 1 : 0,
                isB2C: t.isB2C,
                receptionUin: t.receptionUin
            };
            F(t), A.setCustomParams(e), setTimeout(function () {
                E(i.CGIS.GET_QQ_INVITE_SIGT, e, function (t) {
                    t = t || {};
                    var e = t.data || {}, i = e.sign, n = e.message || "企业接待暂时无法使用，请稍后再试";
            ...
            var i = t.kfuin, n = t.isB2C, a = t.seq, o = t.key, r = t.type, c = t.receptionUin, p = v.createClickId(),
                d = n ? null : l.AUTO, u = {clickid: p, invitationType: d};
        ...
        if (e) {
            var s = o.kfuin, c = o.isB2C, d = (o.seq, o.type, o.receptionUin, e.getAttribute("data-event")),
            ...
            _.addEvent(e, "click", function () {
                if (y("isB2C:" + c), "close" == d) {
                    F(o), L.__WPA.trigger("startInviteTimeout", s), h = {
                        act: C.SM_REFUSE,
                        kfuin: s
                    }, h[n] = a, h = T.stringify(h), t = t ? t : B[P], t.postMessage(h, "*");
        ...
        var n = t.contentWindow, a = t.contentDocument || n.document, o = e.kfuin, r = i.ctx, l = i.isB2C, s = i.type,
            c = i.receptionUin, p = i.key, d = i.seq;
        M[o] = !0;
        var u = a.getElementById("invite_close"), h = a.getElementById("btn1"), f = a.getElementById("btn2");
        f && "undefined" == f.getAttribute("data-event") && (f.parentNode && f.parentNode.removeChild(f), setTimeout(function () {
            f = null
        }, 10)), D(u, {
            kfuin: o,
            iframe: t,
        ...
        i = i || {};
        var n = t.inviteTpl, a = t.inviteConf, o = a.kfuin, r = a.autoInvited || {}, l = r.active, s = r.repeat || {},
            c = s.active || !1, p = s.finterval, u = Number(s.frequency), h = r.reception || {},
            g = (h.type, h.cuin, r.condition || {}), m = g.stayPeriod, b = g.deviceType, x = i.isInviteApi;
        "undefined" == typeof L.__WPA[d][o] && (L.__WPA[d][o] = u), (x || l) && ((x || 3 == b || f && 1 == b || !f && 2 == b) && (x || 0 == m ? z({
            inviteTpl: n,
            inviteConf: a
        }, e) : setTimeout(function () {
            z({inviteTpl: n, inviteConf: a}, e)
        }, 1e3 * m)), c && L.__WPA.on("startInviteTimeout", function (t) {
            return L.__WPA[d][t] < 0 ? y("auto invite reached max times") : void (L.__WPA.KFUINS[t].setTimeoutInvite = setTimeout(function () {
                z({inviteTpl: n, inviteConf: a}, e)
            }, 1e3 * p))
        }))
    }, z = exports.showInvitation = function (t, e) {
        var i = t.inviteTpl, n = t.inviteConf, a = t.isB2C, o = t.seq, r = t.type, l = t.key, s = t.receptionUin,
            p = n.kfuin, g = c + p, m = i.css, b = x.getIframeStyle(i, n), v = b.style, _ = b.width, E = b.height,
            k = n.btns || [];
        k.length;
        if (!L.__WPA.IM_CHAT_IFRAME_OPENING) {
            ...
            try {
                ...
                I = O.createElement("iframe"), I.width = _, I.height = E, I.id = g, I.style.cssText = v, I.setAttribute("scrolling", "no"), I.setAttribute("frameborder", 0), I.setAttribute("allowtransparency", !0), I.setAttribute("src", "about:blank"), f || (I.width = _)
            }
            N.appendChild(I);
            var S = function () {
                var t = I.contentWindow, c = I.contentDocument || t.document;
        ...
        btns: [{type: "im", text: "网页咨询"}],
        theme: "1"
    };
    exports.init = function (t, e) {
        e = e || {};
        var i = this, n = t.key, a = this.params.fkfuin, o = t, r = o.invitedStyle || G, l = x.getTpl(r),
            s = e.isInviteApi;
        (!W[a] || s) && (W[a] = !0, o.kfuin = a, L.__WPA[R][a] = {tpl: l, conf: o, key: n}, j({
            inviteTpl: l,
            inviteConf: o
        }, i, e))
    }, exports.getInviteConf = e, exports.tpl = x
}), LBF.define("wpa.proto.socket", function (require, exports, module) {
    var t, e = require("wpa.conf.config"), i = e.POST_MESSAGE_FLAG, n = e.POST_MESSAGE_FLAG_CONTENT, a = e.KFUINS,
        o = e.isMobile ? 1 : 0, r = e.WEB_IM.WEB_IM_IFRAME_ID, l = e.WPAS_BASED_ON_KFUIN, s = e.gWin, c = s.document,
        p = c.body, d = require("wpa.util.log"), u = e.SOCKET, h = u.ACTS, f = u.URL, g = u.SOCKET_IFRAME_ID,
        m = e.INVITE_IFRAME_ID_PREFIX, b = e.UNREAD_MSG_INFO, x = (e.WEB_IM.WPAS_IM_TYPE, require("wpa.invite.main")),
        v = require("wpa.invite.inviteApi"), _ = require("wpa.util.domEvent"), w = require("wpa.im.init"),
        y = require("wpa.proto.UnreadMsgCircle"), E = require("wpa.util.onIframeLoaded"), k = e.sandbox,
        T = require("lang.JSON"), I = ["width:0", "height:0", "position:fixed", "right:0", "bottom:0"].join(";") + ";",
        A = !1, S = [], C = c.referrer, P = s.location.href, q = c.title;
    s.__WPA[b] = {};
    var L, O = function () {
        _.addEvent(s, "message", function (p) {
            var u = p.data || {}, f = p.origin || p.originalEvent.origin;
            if (d("[socket.js]:origin is:" + f), !e.IM_ORIGIN_REG.test(f)) return d("[socket.js]origin error");
            if ("string" == typeof u) try {
                u = T.parse(u)
            } catch (p) {
                d("JSON.parse error in initSocketListener"), d(p)
            }
            var g = u.act, _ = u.kfuin, E = u.data || {};
            if (g == h.SM_READY) N(t); else if (g == h.SM_UNREAD) {
                var I = k.Number(E.number), A = E.offlineMsgKey, S = E.key, C = E.receptionUin, P = E.receptionName;
                if (I > 0 && (s.__WPA[b][_] = {
                    offlineMsgKey: A,
                    key: S,
                    receptionUin: C,
                    receptionName: P
                }), s.__WPA[a][_] && (s.__WPA[a][_].unread.socket = I), o) y.showAllRedCircles(_, I); else {
                    var q = r + _, O = void 0 !== typeof E.theme ? E.theme : 1, B = document.getElementById(q);
                    L = {
                        act: h.UPDATE_UNREAD,
                        kfuin: _,
                        offlineMsgKey: A,
                        ...
                        receptionName: P,
                        number: I
                    }, L[i] = n, L = T.stringify(L), B.contentWindow.postMessage(L, "*")
                }
            } else if (g == h.SM_MANUAL_INVITE) {
                d("SM_MANUAL_INVITE");
                var M = E.type, W = E.seq, S = E.key, C = E.receptionUin;
                if (1 == M) if (s.__WPA.GLOBAL_INVITE_TPL_AND_CONF[_]) {
                    var R = s.__WPA.GLOBAL_INVITE_TPL_AND_CONF[_], F = R.tpl, U = R.conf;
                    if (c.getElementById(m + _)) return d("invite panel already exists");
                    w.isImIframeLoaded(_) ? x.showInvitation({
                        inviteTpl: F,
                        inviteConf: U,
                        isB2C: !0,
                        seq: W,
                        ...
                        key: S,
                        receptionUin: C
                    }, null) : w.initIframe({kfuin: _})
                } else d("invite rule with kfuin " + _ + " does not exist"); else if (2 == M) s.__WPA.IM.openChatIframe({
                    kfuin: _,
                    seq: W,
                    receptionUin: C,
                    key: S,
                    ...
                    var q = r + _, D = document.getElementById(q);
                ...
                if (R.kfuin = _, d(R), "undefined" == typeof s.__WPA.GLOBAL_INVITE_TPL_AND_CONF[_] && s.__WPA[l][_]) {
                    for (var Q = 0, j = s.__WPA[l][_].length; j > Q; Q++) {
                        var z = s.__WPA[l][_][Q];
                        if (z.params.cate == e.TYPES.QQ || z.params.cate == e.TYPES.IM) break
                    }
                    z.Invite.init.call(z, R), v.add(z, R)
                }
            } else if (g == h.SM_REFUSE) L = {
                act: h.SM_REFUSE,
                kfuin: _
            }, L[i] = n, L = T.stringify(L), t.postMessage(L, "*"); else if (g == h.SMS_SM_FORCE_CONNECT) L = {act: h.SMS_SM_FORCE_CONNECT}, L[i] = n, L = T.stringify(L), t.postMessage(L, "*"); else if (g == h.SM_CHAT_OVER) s.__WPA.trigger("startInviteTimeout", _); else if (g == h.DISCONNECT) {
                var G = s.__WPA[a];
                for (var Q in G) G.hasOwnProperty(Q) && (L = {act: h.DISCONNECT}, L[i] = n, L = T.stringify(L), c.getElementById(r + Q).contentWindow.postMessage(L, "*"))
            }
        })
    }, N = function (e) {
    ...
    exports.establishSocket = function () {
        var i = this, n = i.params, a = (this.env.isGray, n.fkfuin), r = n.guid, l = g, d = {
            kfuin: a,
            visitorId: r,
            isMobile: o,
            act: h.SM_INIT,
            referUrl: C,
            ua: window.navigator.userAgent,
            ldpUrl: decodeURIComponent(P),
            ldpTitle: decodeURIComponent(q)
        };
        if (B || (B = !0, O()), !(n.cate != e.TYPES.IM && n.cate != e.TYPES.QQ || e.isInAdmin || (S.push(d), t || A))) {
            A = !0;
            var u,
                m = '<iframe scrolling="no" id="' + l + '" frameborder="0" width="0" height="0" allowtransparency="true" src="' + f + '" style="' + I + '"></iframe>';
            try {
                u = c.createElement(m)
            } catch (b) {
                u = c.createElement("iframe"), u.width = 0, u.height = 0, u.id = l, u.style.cssText = I, u.setAttribute("scrolling", "no"), u.setAttribute("frameborder", 0),
                    u.setAttribute("allowtransparency", !0), u.setAttribute("src", f)
            }
            p.appendChild(u), E(u, function () {
                t = s.__WPA[g] = u.contentWindow
            })
        }
    }
}), LBF.define("wpa.proto.getGdtClickId", function (require, exports, module) {
    var t = require("util.jsonp"), e = (require("wpa.util.removeCustomProperty"), require("lang.extend")),
        i = require("wpa.conf.config"), n = i.gWin, a = require("wpa.proto.getCPType"), o = "jsonp_cb_", r = 0,
        l = "https://t.gdt.qq.com/conv/web/cookies/jsonp", s = o + r++, c = function (i) {
            if ("undefined" == typeof n._gdtClickId) {
                var o = {cb: s, callback: s};
                t(l, o, function (t) {
                    t && 0 == t.ret ? n._gdtReportData = e({
                        client_id: 54,
                        click_id: t.click_id,
                        visitorid: i.guid,
                        kfuin: i.fkfuin,
                        ldpg: n.location.href
                    }, a(i)) : n._gdtReportData = 0
                })
            }
        };
    ...
    var t = (require("lang.browser"), require("wpa.util.getOffset"), require("wpa.conf.config")),
        e = t.WPAS_BASED_ON_KFUIN, i = t.KFUINS, n = t.isMobile, a = t.gWin, o = t.TYPES.IM, r = t.TYPES.QQ,
    ...
    exports.showAllRedCircles = function (t) {
        if (n) {
            var o = a.__WPA[i][t].unread, r = o.chat + o.socket;
            if (!(0 >= r)) {
                return void (a.__WPA[e][t] && a.__WPA[e][t][0].updateUnreadMsgCircle(r));
                var o, r
            }
        }
    };
    exports.removeUnreadMsgCircle = function (t) {
        n && c(this.params.cate) && l.removeUnreadMsgBar(t)
    };
    exports.removeAllRedCircles = function (t) {
        ...
        if (n) {
            ...
            if (c(this.params.cate)) {
                var e = a.__WPA[i][t].unread, o = e.chat + e.socket;
                l.drawBar({kfuin: t, number: o})
            }
        }
    }
}), LBF.define("wpa.proto.pvReport", function (require, exports, module) {
    var t = require("wpa.conf.config"), e = t.gWin, i = e.document, n = t.ENV, a = require("lang.extend"),
    ...
    var l = e.__QIDIAN.kfuins, s = {
        mid: "",
        ldpg: e.location.href,
        refurl: "undefined" != typeof i.referrer ? i.referrer : "",
        ua: e.navigator.userAgent,
        title: encodeURIComponent(i.title),
        eptype: t.isMobile ? 2 : 1,
        env: n
    };
    exports.pvReport = function (t) {
        var e = t.kfuin;
        l[e] || (l[e] = !0, setTimeout(function () {
            o({action: r, data: a({kfuin: e}, s)})
        }, 300))
    }, exports.setGlobalVisitorId = function (t) {
        var i = t.vid, n = t.pid, a = t.qid;
    ...
    var t = require("util.localStorage"), e = require("util.Cookie"), i = require("wpa.util.log"),
        n = require("wpa.conf.config"), a = n.gWin, o = "isDaAdded", r = "isFetchingDa", l = 11, s = [],
        c = document.head || document.getElementsByTagName("head")[0] || document.documentElement,
        p = c.getElementsByTagName("base")[0], d = function (t, e, i) {
            var n = document.createElement("script");
            n.charset = "utf-8", n.async = !0, n.src = t, n.id = e || "";
            var a = n;
            n.onreadystatechange = n.onload = function () {
                /loaded|complete|undefined/.test(n.readyState) && "function" == typeof i && (i(), n.onreadystatechange = n.onload = null)
            }, p ? c.insertBefore(n, p) : c.appendChild(n), a = null
        }, u = "", h = !1, f = i, g = function () {
            try {
                var t = a, i = "__qq_qidian_da", n = t[i] || "qidianDA";
                if (!n) return;
                var o = t[n], r = s.shift();
                if (!r) return;
                o("create", String(r), {cid: String(u), src: l, pgv_pvi: e.get("pgv_pvi") || ""}), o("set", "t1", new Date)
            } catch (c) {
                f("[WPA][qidianDAReport]:error occured"), f(c)
            }
        }, m = function (e) {
            h || (u = t.getItem(n.tencentSig) || "", h = !0), s.push(e), a[r] ? a[o] && g() : (a[r] = !0, d("//bqq.gtimg.com/da/i.js", "_da", function () {
                a[o] = !0, g()
            }))
        };
    ...
    var t, e, i, n = require("lang.browser"),
        ...
        o = (require("lang.extend"), require("util.jsonp")), r = require("wpa.util.onIframeLoaded"),
        l = require("lang.isFunction"), s = require("wpa.conf.config"), c = (s.CLICK_TYPE, s.gWin), p = s.eptype,
        d = require("wpa.conf.chat"), u = require("globalSettings"),
        ...
        b = s.CGIS, x = 0, v = 1, _ = s.ENV, w = "抱歉，企业暂时无人接待", y = navigator.userAgent.toLowerCase(),
        E = document.getElementsByTagName("body")[0], k = s.BROWSER_ENV.isInMobileQQ, T = document;
    if (n.isMobile) if (y.indexOf("micromessenger") > -1) {
        var I = /QQ\/(\d+\.\d+)\.\d/, A = /V1_AND_SQ_(\d+\.\d+)\.\d/, S = I.exec(y) || A.exec(y);
    ...
    exports.PCChat = function (t, e) {
        ...
        t.isPub && (n = b.GET_MP_SIGT[_]), g.setCustomParams(i), o(n, i, function (i) {
            ...
            if (s.isSSL && !s.BROWSER_ENV.isIE) c.location.href = i.data.sign, setTimeout(function () {
                l(e) && e(t)
            }, 1e3); else {
        ...
        var i = (a.domain, t.fkfuin, t.fkfext, {
            kfuin: t.fkfuin,
            kfext: t.fkfext,
            visitorId: t.guid,
            visitorid: t.guid,
    ...
    var t = require("wpa.conf.config"), e = t.gWin, i = e.__WPA, n = [];
    i.inviteKfuinReadyState = [], i.on("inviteApi", function (t) {
        for (var e = 0; e < n.length; e++) t && -1 === t.indexOf(n[e].inviteRule.kfuin) || n[e].wpa.Invite.init.call(n[e].wpa, n[e].inviteRule, {isInviteApi: !0})
    });
    var a = function (t, e) {
        n.push({
            wpa: t,
            inviteRule: e
        }), i.inviteKfuinReadyState.push(e.kfuin), "function" == typeof window.__WPAInviteReady && window.__WPAInviteReady(i.inviteKfuinReadyState)
    }, o = function (t) {
        i.trigger("inviteApi", t)
    };
    exports.add = a, exports.trigger = o
}), LBF.define("wpa.util.badjs", function (require, exports, module) {
    var t = require("wpa.conf.config"), e = t.badjs, i = e.id, n = e.random, a = function (t) {
        ...
        var e = [], i = {
            ...
            return null === t ? !0 : n(t, "Number") ? !1 : !t
        }, r = function (t) {
            try {
                if (t.stack) {
                ...
                for (var s in t) {
                    ...
                    if (!o(c)) {
                        if (a(c)) try {
                            ...
                            c = "[BJ_REPORT_FOR_WPA detect value stringify error] " + p.toString()
                        }
            ...
            if (i.report) {
                for (; e.length;) {
                    var a = !1, o = e.shift(), r = s(o, d.length);
                    if (n(i.ignore, "Array")) for (var l = 0, c = i.ignore.length; c > l; l++) {
                        var h = i.ignore[l];
                        if (n(h, "RegExp") && h.test(r[1]) || n(h, "Function") && h(o, r[1])) {
                            a = !0;
                            break
                        }
                    }
                ...
                if (f) {
                    var g = function () {
                        clearTimeout(u), p(i.report + d.join("&") + "&count=" + d.length + "&_t=" + +new Date), u = 0, d = []
                    };
            ...
            push: function (t) {
                if (Math.random() >= i.random) return f;
                var n = a(t) ? r(t) : {msg: t};
                return i.ext && !n.ext && (n.ext = i.ext), e.push(n), h(), f
            }, report: function (t) {
                return t && f.push(t), h(!0), f
            }, info: function (t) {
                return t ? (a(t) ? t.level = 2 : t = {msg: t, level: 2}, f.push(t), f) : f
            }, debug: function (t) {
                return t ? (a(t) ? t.level = 1 : t = {msg: t, level: 1}, f.push(t), f) : f
            }, init: function (t) {
                if (a(t)) for (var e in t) i[e] = t[e];
    ...
    function t(a) {
        var o = i(arguments), r = function () {
            this.initialize.apply(this, arguments)
        }, l = function () {
        };
        l.prototype = this.prototype;
        var s = new l;
        return s.constructor = r, s.superclass = this, o.unshift(s), n.apply(o, o), r.prototype = s, n(r, {
            inherit: t,
            include: e,
            extend: t,
            superclass: this
    ...
    function e(t) {
        var e = i(arguments);
        return e.unshift(this), n.apply(this, e), this
    }

    var i = require("lang.toArray"), n = require("lang.extend");
    module.exports = t.call(Function, {
        initialize: function () {
        }, mixin: e
    })
}), LBF.define("lang.inArray", function (require, exports, module) {
    module.exports = [].indexOf ? function (t, e, i) {
        return e ? [].indexOf.call(e, t, i) : -1
    } : function (t, e, i) {
        if (e) {
            var n = e.length;
            for (i = i ? 0 > i ? Math.max(0, n + i) : i : 0; n > i; i++) if (i in e && e[i] === t) return i
        }
        return -1
    }
}), LBF.define("wpa.util.onIframeLoaded", function () {
    return function (t, e, i) {
        if (i) if (/loaded|complete/.test(t.readyState)) e(); else if (t.attachEvent) {
            var n = function () {
                t.detachEvent("onload", n), e()
            };
            t.attachEvent("onload", n)
        } else t.onload = function () {
            e(), t.onload = null
        }; else if (/loaded|complete|undefined/.test(t.readyState)) e(); else if (t.attachEvent) {
            var n = function () {
                t.detachEvent("onload", n), e()
            };
            t.attachEvent("onload", n)
    ...
    var t = require("util.xssFilter"), e = (require("lang.inArray"), require("globalSettings")),
        i = (-1 !== e.protocol.indexOf("https") ? !0 : !1, require("wpa.conf.defaultConst"), {
            1: "theme-1",
            2: "theme-2",
            3: "theme-3",
            4: "theme-4",
    ...
    return {
        compile: function (e) {
            var n = e.tpl, a = e.params, o = e.htmlRequired || [], r = a.theme, l = {
                theme: i[r],
                btnText: t.htmlEncode(a.btnText),
                title: t.htmlEncode(a.title),
                signature: t.htmlEncode(a.signature),
                avatar: a.avatar,
                qrcode: a.qrcode || "",
                closable: a.closable || "closable",
                btnBgColor: a.btnBgColor.value
            };
    ...
    var t = (require("wpa.conf.colors"), require("wpa.util.borderRadiusMixin"), require("lang.inArray"), require("wpa.util.urlBackground"), {
    ...
    return {
        load: function (t, e, i) {
            i = i || {};
            var n = i.context || document, a = n.createElement("link");
            return a.name = t, a.type = "text/css", a.setAttribute("rel", "stylesheet"), a.setAttribute("href", e), function () {
                try {
            ...
            var n = i.name, a = (i.self || {}, i.dispType, i.cssText),
                o = (i.htmlRequired || {}, i.borderRadius, i.doc), r = o || document, l = r.createElement("style");
            ...
            var e = t.name, i = (t.self || {}, t.dispType, t.cssText), n = t.doc, a = n || document,
    ...
    var t = require("wpa.conf.defaultConst"), e = (t.POSITION, {
        1: {
            1: {
                cate: 1,
                type: 1,
            ...
            6: {
                ...
                type: 6,
                isPC: 1,
                floatStyle: {gap: {right: "10px", bottom: "20px"}},
                borderRadius: "2px",
                htmlRequired: ["title", "signature", "btnBgColor", "btnText", "avatar"]
            },
            7: {cate: 1, type: 7, floatStyle: {gap: {right: "15px", bottom: "20px"}}},
            8: {cate: 1, type: 8, floatStyle: {gap: {right: "15px", bottom: "20px"}}, htmlRequired: ["btnText"]},
            9: {
                cate: 1,
                type: 9,
            ...
            15: {
                ...
                isInQQ: 1,
                iframeBorder: {width: "1px", color: "#ebebeb"}
            }
        },
        2: {
            1: {
                ...
                scene: 0,
                htmlRequired: [],
                floatStyle: {gap: {right: "15px", bottom: "20px"}},
                required: ["role"],
                role: ["roleTEL"]
            },
            2: {cate: 2, type: 2, floatStyle: {gap: {right: "15px", bottom: "20px"}}, htmlRequired: ["btnText"]},
            3: {
                cate: 2,
                type: 3,
        ...
        3: {
            ...
            2: {
                ...
                tpl: 6,
                tplOptions: {eventList: ["callAddFan"], fixedBtnText: "关注", btnWithoutIconAdd: !0, hasAvatar: 1}
            },
            3: {
                cate: 3,
                type: 3,
                ...
                tpl: 6,
                tplOptions: {eventList: ["callAddFan"], fixedBtnText: "关注", btnWithoutIconAdd: !0, hasAvatar: 0}
            }
        },
        4: {
            1: {
            ...
            2: {
                ...
                htmlRequired: ["btnText", "title", "signature", "btnBgColor", "theme", "closable", "position"],
                tpl: 6,
                tplOptions: {eventList: ["callAddGroup"], fixedBtnText: "QQ群", hasAvatar: 0}
            },
            3: {
                cate: 4,
                type: 3,
                ...
                tpl: 6,
                tplOptions: {eventList: ["callAddGroup"], fixedBtnText: "QQ群", hasAvatar: 1}
            },
            4: {
                cate: 4,
                type: 4,
        ...
        5: {
            ...
            2: {
                ...
                htmlRequired: ["btnText", "title", "signature", "btnBgColor", "theme", "closable", "position"],
                tpl: 6,
                tplOptions: {eventList: ["callAddPal"], fixedBtnText: "好友", hasAvatar: 0}
            },
            3: {
                cate: 5,
                type: 3,
                htmlRequired: ["btnText", "title", "signature", "btnBgColor", "theme", "closable", "position", "avatar"],
                tpl: 6,
                tplOptions: {eventList: ["callAddPal"], fixedBtnText: "好友", hasAvatar: 1}
            },
            4: {
                cate: 5,
                type: 4,
        ...
        7: {
            1: {
                ...
                htmlRequired: ["theme"],
                floatStyle: {gap: {right: "15px", bottom: "20px"}},
                fixedCircleOffset: {x: {key: "right", value: -5}, y: {key: "bottom", value: 30}}
            },
            2: {
                cate: 7,
                type: 2,
                floatStyle: {gap: {right: "15px", bottom: "20px"}},
                fixedCircleOffset: {x: {key: "right", value: -5}, y: {key: "bottom", value: 26}},
                htmlRequired: ["btnText", "theme"]
            },
            3: {
                cate: 7,
                ...
                htmlRequired: ["closable", "btnText", "title", "signature", "theme", "position", "avatar"],
                tpl: 3,
                tplOptions: {iconList: ["icon-im"], eventList: ["callIm"], hasBtnText: 1, hasAvatar: 1},
                circleOffset: {x: {key: "right", value: -27}, y: {key: "bottom", value: 15}},
                fixedCircleOffset: {x: {key: "right", value: 17}, y: {key: "bottom", value: 40}}
            },
            4: {
                cate: 7,
                type: 4,
                htmlRequired: ["closable", "btnText", "title", "signature", "theme", "position"],
                tpl: 3,
                tplOptions: {iconList: ["icon-im"], eventList: ["callIm"], hasBtnText: 1, hasAvatar: 0},
                circleOffset: {x: {key: "right", value: -27}, y: {key: "bottom", value: 15}},
                fixedCircleOffset: {x: {key: "right", value: 17}, y: {key: "bottom", value: 40}}
            },
            5: {
                ...
                circleOffset: {x: {key: "right", value: -80}, y: {key: "bottom", value: 22}},
                fixedCircleOffset: {x: {key: "right", value: 71}, y: {key: "bottom", value: 32}}
            },
            6: {
                cate: 7,
                type: 6,
            ...
            7: {
                ...
                tpl: 4,
                tplOptions: {iconList: ["icon-im"], eventList: ["callIm"], hasBtnText: 1, hasAvatar: 1},
                circleOffset: {x: {key: "right", value: -15}, y: {key: "bottom", value: 15}},
                fixedCircleOffset: {x: {key: "right", value: 5}, y: {key: "bottom", value: 46}}
            },
            8: {
                cate: 7,
                type: 8,
                ...
                circleOffset: {x: {key: "right", value: -72}, y: {key: "bottom", value: 22}},
                fixedCircleOffset: {x: {key: "right", value: 62}, y: {key: "bottom", value: 40}}
            },
            9: {
                cate: 7,
                type: 9,
            ...
            12: {
                ...
                type: 10,
                isPC: 1,
                floatStyle: {gap: {left: "10px", bottom: "10px"}},
            ...
            14: {cate: 7, type: 14, isPC: 1, floatStyle: {gap: {right: "0"}}, htmlRequired: ["theme"]}
        }
    });
    module.exports = e
}), LBF.define("wpa.util.insertIframe", function (require, exports, module) {
    var t = require("lang.browser"), e = function (e) {
        var i = document.getElementsByTagName("script"), n = i[i.length - 1], a = e.ele,
            o = e.lastScript ? e.lastScript : n, r = e.container;
        if (!r) return void o.parentNode.insertBefore(a, o);
        if ("string" == typeof r) {
            var l = document.getElementById(r);
            if (!l) throw new Error("无法找到container，该container id对应元素不存在或者不在DOM中");
            var s = "BackCompat" === document.compatMode;
            return void (t.msie && parseInt(t.version, 10) < 7 || s ? document.body.appendChild(a) : l.appendChild(a))
        }
    ...
    var t = (require("lang.browser"), require("wpa.conf.defaultConst")), e = t.POSITION,
        i = (require("wpa.util.offset"), 1), n = "z-index: 2000000000;", a = "position:fixed;";
    exports.getFloatStyle = function (t) {
        var o = t.position, r = t.location, l = t.defaultPosition, s = "number" == typeof t.width ? !0 : !1,
            c = s ? t.width : 0, p = "number" == typeof t.height ? t.height : 0, d = "0px", u = t.floatStyle || {},
            h = u.gap || {}, f = (h.top || d, h.bottom || d), g = h.right || d, m = h.left || d, b = p / 2, x = "";
        if ("undefined" != typeof r) {
            var v = r.h || {}, _ = r.v || {}, w = v.type, y = v.px || 0, E = _.type, k = _.px || 0;
    ...
    var t, e, i = require("wpa.conf.config"), n = i.imageBaseUrl, a = i.TYPES, o = require("lang.extend"),
        r = require("lang.browser"), l = require("wpa.conf.defaultConst"), s = l.defaultEventTagName,
        c = require("wpa.conf.wpaType"), p = require("wpa.util.replaceImg3X"), d = require("wpa.conf.tpl"),
        u = r.isAndroid, h = (r.isIOS, {2: "#12b7f5", 3: "#0067ed", 4: "#ff9232", 5: "#ee685d", 6: "#25cd98"}),
        f = l.POSITION, g = require("wpa.util.getSize");
    module.exports = exports = {
        init: function (i) {
            i = i || {};
            var r = i.ratio || 1, l = {ratio: r}, m = g(i.ratio);
            t = {
                1: d(1, o({hasAvatar: 1}, l)),
                2: d(2, l),
                3: d(1, l),
                "1_9": d(c[a.QQ][9].tpl, o(c[a.QQ][9].tplOptions, l)),
                "1_10": d(c[a.QQ][10].tpl, o(c[a.QQ][10].tplOptions, l)),
                "1_11": d(c[a.QQ][11].tpl, o(c[a.QQ][11].tplOptions, l)),
                "1_12": d(c[a.QQ][12].tpl, o(c[a.QQ][12].tplOptions, l)),
                "1_13": d(c[a.QQ][13].tpl, o(c[a.QQ][13].tplOptions, l)),
                "1_14": d(c[a.QQ][14].tpl, o(c[a.QQ][14].tplOptions, l)),
                "2_3": d(c[a.PHONE][3].tpl, o(c[a.PHONE][3].tplOptions, l)),
                "2_4": d(c[a.PHONE][4].tpl, o(c[a.PHONE][4].tplOptions, l)),
                "2_5": d(c[a.PHONE][5].tpl, o(c[a.PHONE][5].tplOptions, l)),
                "2_6": d(c[a.PHONE][6].tpl, o(c[a.PHONE][6].tplOptions, l)),
                "2_7": d(c[a.PHONE][7].tpl, o(c[a.PHONE][7].tplOptions, l)),
                "2_8": d(c[a.PHONE][8].tpl, o(c[a.PHONE][8].tplOptions, l)),
                "3_2": d(c[a.PUB][2].tpl, o(c[a.PUB][2].tplOptions, l)),
                "3_3": d(c[a.PUB][3].tpl, o(c[a.PUB][3].tplOptions, l)),
                "4_2": d(c[a.GROUP][2].tpl, o(c[a.GROUP][2].tplOptions, l)),
                "4_3": d(c[a.GROUP][3].tpl, o(c[a.GROUP][3].tplOptions, l)),
                "4_4": d(c[a.GROUP][4].tpl, o(c[a.GROUP][4].tplOptions, l)),
                "5_2": d(c[a.KFEXT][2].tpl, o(c[a.KFEXT][2].tplOptions, l)),
                "5_3": d(c[a.KFEXT][3].tpl, o(c[a.KFEXT][3].tplOptions, l)),
                "5_4": d(c[a.KFEXT][4].tpl, o(c[a.KFEXT][4].tplOptions, l)),
                "7_3": d(c[a.IM][3].tpl, o(c[a.IM][3].tplOptions, l)),
                "7_4": d(c[a.IM][4].tpl, o(c[a.IM][4].tplOptions, l)),
                "7_5": d(c[a.IM][5].tpl, o(c[a.IM][5].tplOptions, l)),
                "7_6": d(c[a.IM][6].tpl, o(c[a.IM][6].tplOptions, l)),
                "7_7": d(c[a.IM][7].tpl, o(c[a.IM][7].tplOptions, l)),
                "7_8": d(c[a.IM][8].tpl, o(c[a.IM][8].tplOptions, l))
            }, e = {
                ...
                1: {
                    1: {
                        ...
                        height: 30,
                        accurateSize: 1,
                        tpl: ['<a href="javascript:void(0);" name="' + s + '" class="wpa-container {theme}" data-event="callChat">', '<span class="icon-qq"></span>', '<span class="btn-text">{btnText}</span>', "</a>"].join(""),
                    ...
                    3: {
                        ...
                        accurateSize: 1,
                        defaultPosition: f[6],
                        tpl: ['<a class="wpa-container" data-event="callChat" name="' + s + '">', '<img class="avatar" src="{avatar}" />', '<span class="icon-qq"></span>', '<span class="title">{title}</span>', '<span class="signature">{signature}</span>', "</a>"].join(""),
                    ...
                    5: {
                        ...
                        accurateSize: 1,
                        defaultPosition: f[6],
                        tpl: ['<a class="wpa-container" data-event="callChat" name="' + s + '">', '<span class="title">{title}</span>', '<img class="avatar" src="{avatar}" />', '<span class="btn-area" style="background: {btnBgColor}">', '<span class="icon-qq"></span>', '<span class="btn-text">{btnText}</span>', "</span>", "</a>"].join(""),
                    ...
                    7: {
                        ...
                        accurateSize: 1,
                        defaultPosition: f[9],
                        tpl: ['<a class="wpa-container" data-event="callChat" name="' + s + '">', '<span class="icon-qq"></span>', "</a>"].join(""),
                    ...
                    8: {
                        ...
                        accurateSize: 1,
                        defaultPosition: f[9],
                        tpl: ['<a class="wpa-container" data-event="callChat" name="' + s + '">', '<span class="v"></span>', '<span class="icon-qq"></span>', '<span class="btnText">在线咨询</span>', "</a>"].join(""),
                ...
                2: {
                    1: {
                        ...
                        accurateSize: 1,
                        defaultPosition: f[9],
                        tpl: ['<a href="javascript:void(0);" class="wpa-container" name="' + s + '" data-event="callPhone">', '<img class="icon-call" src="' + n + '/icon-call-44-2x.png" srcset="' + n + "/icon-call-44-2x.png 1x, " + n + '/icon-call-44-3x.png 2x" />', "</a>"].join(""),
                        cssText: ["* {{common}}", ".wpa-container {{dib}width: " + m(84) + "px;height: " + m(84) + "px;text-decoration: none;text-align: center;border-radius: 100%;border: 1px solid #dadee7;background:#fff;line-height: " + m(78) + "px;}", ".wpa-container img {vertical-align: middle; width: " + m(42) + "px; height: " + m(42) + "px;}"].join("")
                    },
                    2: {
                        width: 250,
                        height: 78,
                        accurateSize: 1,
                        defaultPosition: f[9],
                        tpl: ['<a class="wpa-container" data-event="callPhone" name="' + s + '">', '<span class="v"></span>', '<span class="icon-call"></span>', '<span class="btnText">免费电话</span>', "</a>"].join(""),
                    ...
                    3: {width: "100%", height: 130, accurateSize: 0, tpl: t["2_3"]().tpl, cssText: t["2_3"]().cssText},
                    4: {width: "100%", height: 130, accurateSize: 0, tpl: t["2_4"]().tpl, cssText: t["2_4"]().cssText},
                    5: {width: "100%", height: 130, accurateSize: 0, tpl: t["2_5"]().tpl, cssText: t["2_5"]().cssText},
                    6: {width: "100%", height: 130, accurateSize: 0, tpl: t["2_6"]().tpl, cssText: t["2_6"]().cssText},
                    7: {width: "100%", height: 140, accurateSize: 0, tpl: t["2_7"]().tpl, cssText: t["2_7"]().cssText},
                    8: {width: "100%", height: 140, accurateSize: 0, tpl: t["2_8"]().tpl, cssText: t["2_8"]().cssText}
                },
                3: {
                    1: {
                        width: 404,
                        ...
                        defaultPosition: f[9],
                        tpl: t[2]({event: 5}).tpl,
                        cssText: t[2]({event: 5}).cssText
                    },
                    2: {width: "100%", height: 140, accurateSize: 0, tpl: t["3_2"]().tpl, cssText: t["3_2"]().cssText},
                    3: {width: "100%", height: 140, accurateSize: 0, tpl: t["3_3"]().tpl, cssText: t["3_3"]().cssText}
                },
                4: {
                    1: {
                        width: 404,
                        ...
                        defaultPosition: f[9],
                        tpl: t[2]({event: 4}).tpl,
                        cssText: t[2]({event: 4}).cssText
                    },
                    2: {width: "100%", height: 140, accurateSize: 0, tpl: t["4_2"]().tpl, cssText: t["4_2"]().cssText},
                    3: {width: "100%", height: 140, accurateSize: 0, tpl: t["4_3"]().tpl, cssText: t["4_3"]().cssText},
                    4: {width: "100%", height: 140, accurateSize: 0, tpl: t["4_4"]().tpl, cssText: t["4_4"]().cssText}
                },
                5: {
                    1: {
                        width: 404,
                    ...
                    2: {width: "100%", height: 140, accurateSize: 0, tpl: t["5_2"]().tpl, cssText: t["5_2"]().cssText},
                    3: {width: "100%", height: 140, accurateSize: 0, tpl: t["5_3"]().tpl, cssText: t["5_3"]().cssText},
                    4: {width: "100%", height: 140, accurateSize: 0, tpl: t["5_4"]().tpl, cssText: t["5_4"]().cssText}
                },
                7: {
                    1: {
                        width: 88,
                        ...
                        accurateSize: 1,
                        defaultPosition: f[9],
                        tpl: ['<a class="wpa-container {theme}" data-event="callIm" name="' + s + '">', '<span class="icon-im"></span>', "</a>"].join(""),
                    ...
                    2: {
                        ...
                        accurateSize: 1,
                        defaultPosition: f[9],
                        tpl: ['<a class="wpa-container {theme}" data-event="callIm" name="' + s + '">', '<span class="v"></span>', '<span class="icon-im"></span>', '<span class="btnText">{btnText}</span>', "</a>"].join(""),
                    ...
                    3: {width: "100%", height: 130, accurateSize: 0, tpl: t["7_3"]().tpl, cssText: t["7_3"]().cssText},
                    4: {width: "100%", height: 130, accurateSize: 0, tpl: t["7_4"]().tpl, cssText: t["7_4"]().cssText},
                    5: {width: "100%", height: 130, accurateSize: 0, tpl: t["7_5"]().tpl, cssText: t["7_5"]().cssText},
                    6: {width: "100%", height: 130, accurateSize: 0, tpl: t["7_6"]().tpl, cssText: t["7_6"]().cssText},
                    7: {width: "100%", height: 140, accurateSize: 0, tpl: t["7_7"]().tpl, cssText: t["7_7"]().cssText},
                    8: {width: "100%", height: 140, accurateSize: 0, tpl: t["7_8"]().tpl, cssText: t["7_8"]().cssText},
                    9: {
                        width: "100%",
                        height: 270,
                        accurateSize: 0,
                        tpl: ['<div class="wpa-container theme-1">', '<div class="qr-code">', '<img src="{qrcode}" class="qr-code-img"/>', '<img src="{avatar}" class="avatar-in-qr-code" />', "</div>", '<div class="info">', '<div class="avatar">', '<span class="title">{title}</span>', "</div>", '<div class="signature">', "{signature}", "</div>", "</div>", "</div>"].join(""),
                        cssText: ["* {{common}}", ".wpa-container {z-index:1;{dib}position: relative;width: 100%;height: " + m(230) + "px;padding: " + m(20) + "px;}", ".theme-1 {background: #fff;box-shadow: 0 0 0 1px #bbb;}", ".theme-2 {background: #19212e;}", ".theme-3 {background: #00a5e0;}", ".theme-4 {background: #ff9232;}", ".theme-5 {background: #ee685d;}", ".theme-6 {background: #33cc99;}", ".qr-code, .info, .title {{dib}}", ".img-avatar {display: none;}", ".qr-code {padding: " + m(15) + "px; background: #fff; position:relative; width: " + m(200) + "px; height: " + m(200) + "px;}", ".qr-code-img {width: " + m(200) + "px;height: " + m(200) + "px;}", ".theme-1 .qr-code {padding: 0; width: " + m(230) + "px; height: " + m(230) + "px;}", ".theme-1 .qr-code-img {width: " + m(230) + "px;height: " + m(230) + "px;}", ".avatar-in-qr-code {width: " + m(50) + "px; height: " + m(50) + "px; position:absolute;top: " + m(90) + "px;left: " + m(90) + "px;display:none;}", ".info {position: absolute;left: " + m(270) + "px;top: " + m(63) + "px;}", ".avatar img {border-radius: 50%;width: " + m(80) + "px;height: " + m(80) + "px;vertical-align: middle;}", ".title {font-size: " + m(36) + "px;vertical-align: middle;margin-left: " + m(0) + "px;color: #fff;{ell}}", ".signature {line-height: 1.6em;font-size: " + m(26) + "px;max-width: 85%;margin-top: " + m(16) + "px;color: #fff;{wordBreak}}", ".theme-1 .signature {color: #999;}", ".theme-1 .title {color: #000;}"].join("")
                    },
                    12: {
                        width: 350,
                        height: 70,
                        accurateSize: 1,
                        defaultPosition: f[7],
                        tpl: ['<a class="wpa-container {theme}" data-event="callIm" name="' + s + '">', '<span style="z-index:9999;" class="icon-im" ></span>', '<img class="avatar" src="{avatar}" />', '<div class="chat-bubble">', '<span class="triangle-back"></span>', '<span class="triangle-front"></span>', '<span class="vm"></span>', '<p class="content">{signature}</p>', "</div>", "</a>"].join(""),
                    ...
                    13: {
                        ...
                        accurateSize: 1,
                        defaultPosition: f[6],
                        tpl: ['<a class="wpa-container {theme}" data-event="callIm" name="' + s + '">', '<img src="{avatar}" class="avatar" />', '<span style="z-index:9999;" class="icon-im"></span>', '<p class="signature">{signature}</p>', "</a>"].join(""),
                        cssText: ["* {{common}}", ".wpa-container {display:block;cursor:pointer;width: 104px;height: 138px;position: relative;text-align: center;font-size: 14px;color: #1e2330;border: 1px solid #dadee7;border-radius: 4px;background: #fff;}", ".avatar {width: 80px;height: 80px;border-radius: 50%;display: inline-block;position:absolute;left:12px;top: 16px;z-index:0;}", ".signature {position: relative;top:109px;}", ".icon-im {display: inline-block;width: 25px;height: 25px;background-repeat: no-repeat;position: absolute;top: 14px;right: 4px;z-index: 10;}", ".theme-2 .icon-im {background-image:url(" + n + "/im-bubble-pc-theme2.png);}", ".theme-3 .icon-im {background-image:url(" + n + "/im-bubble-pc-theme3.png);}", ".theme-4 .icon-im {background-image:url(" + n + "/im-bubble-pc-theme4.png);}", ".theme-5 .icon-im {background-image:url(" + n + "/im-bubble-pc-theme5.png);}", ".theme-6 .icon-im {background-image:url(" + n + "/im-bubble-pc-theme6.png);}"].join("")
                    },
                    14: {
                        width: 80,
                        height: 160,
                        accurateSize: 1,
                        defaultPosition: f[6],
                        tpl: ['<div class="wpa-container {theme}">', '<a class="btn-qq btn" data-event="callChat" name="' + s + '">', '<span class="icon-qq btn-icon"></span><br/>', '<span class="btn-text">QQ</span>', "</a>", '<span class="spliter"></span>', '<a class="btn-im btn" data-event="callIm" name="' + s + '">', '<span class="icon-im btn-icon"></span><br/>', '<span class="btn-text">咨询</span>', "</a>", "</div>"].join(""),
    ...
    exports.addEvent = window.addEventListener ? function (t, e, i) {
        return t.addEventListener(e, i), t
    } : function (t, e, i) {
        return t.attachEvent("on" + e, i), t
    }, exports.removeEvent = window.removeEventListener ? function (t, e, i) {
        return t.removeEventListener(e, i), t
    } : function (t, e, i) {
        return t.detachEvent("on" + e, i), t
    }
    ...
    var t = require("wpa.conf.Events"), e = require("lang.proxy"), i = require("wpa.util.domEvent");
    module.exports = function (n, a) {
        if (n.length) for (var o = 0, r = n.length; r > o; o++) {
            var l = n[o], s = l.attributes["data-event"].nodeValue, c = s.split(";"), p = c[0],
                d = c[1] || t.defaultEventType, u = e(a[p], a);
            u && i.addEvent(l, d, u)
        }
    }
}), LBF.define("wpa.util.htReport", function (require, exports, module) {
    var t = require("wpa.conf.config"), e = t.BROWSER_ENV, i = e.isIOS, n = e.isAndroid, a = "pc", o = 21848, r = 1,
        l = 1, s = "https://report.huatuo.qq.com/report.cgi";
    i ? a = "ios" : n && (a = "android"), module.exports = exports = function (t, e) {
        var i = +new Date, n = i - t, c = new Image,
    ...
    var t = /(^[\s\xA0]+)|([\s\xA0]+$)/g;
    module.exports = String.prototype.trim ? function (t) {
    ...
    var e, i = require("util.request"), n = require("util.serialize"), a = require("lang.dateTool"), o = 0, r = 5e3,
        l = r + 2e3, s = {};
    module.exports = function (r, c, p, d) {
        var u, h = c.cb || "JSONP_CB_" + ++o;
        h += "_" + +new Date + "_" + Math.round(1e3 * Math.random()), c.cb = c.callback = h, e = window.__QDWPABUS ? !0 : !1, r += -1 === r.indexOf("?") ? "?" : "&", r += n(c), function (n) {
            return e && (s[n] = setTimeout(function () {
                var t = a.format("Y-m-d H:i:s", new Date), e = new Error("[CGI NOT REACHED ERROR][" + t + "]cgi: " + r);
                __QDWPABUS.trigger("error", e)
            }, l)), window[n] = function (t) {
                clearTimeout(s[n]), p(t), setTimeout(function () {
                    window[n] = null, u.parentNode && u.parentNode.removeChild(u)
                }, 1)
            }, u = i(r, t, d)
        }(h)
    }
}), LBF.define("wpa.conf.chat", function (require, exports, module) {
    var t = require("globalSettings"), e = t.apiBase, i = "";
    -1 !== e.indexOf("dev") ? i = "dev" : -1 !== e.indexOf("oa") && (i = "oa");
    var n = "https://{env}admin.qidian.qq.com".replace("{env}", i);
    return {
        CHAT_TYPE_AUTO: 1,
        CHAT_TYPE_ANONYMOUS: 2,
        CHAT_TYPE_QQ: 3,
        PC_QQ_SCHEMA_CGI: e + "/wpaInfo/TS",
        WPL_B_QQ_COM_CONV: e + "/wpaInfo/numberInfo",
        ...
        LINK_CHAT: e.replace("https:", "http:") + "/wpaCall/sslCall",
        LAUNCH_MOBILE_QQ: n + "/template/blue/wpa/link.html",
        LAUNCH_LINK: n + "/template/blue/wpa/link.html"
    }
}), LBF.define("wpa.util.offset", function (require, exports) {
    var t = require("wpa.conf.config"), e = t.gWin, i = e.document, n = "CSS1Compat" === i.compatMode,
        a = i.documentElement, o = i.body;
    exports.getScrollTop = function () {
        return Math.max(a.scrollTop, o.scrollTop)
    }, exports.getClientWidth = n ? function () {
        return a.clientWidth
    } : function () {
        return o.clientWidth
    }, exports.getClientHeight = n ? function () {
        return a.clientHeight
    } : function () {
        return o.clientHeight
    }, exports.getNewScrollTop = function () {
        var t = i.documentElement.scrollTop || e.pageYOffset || i.body.scrollTop;
        return t
    }
    ...
    return "object" != typeof JSON && (JSON = {}), function () {
            ...
            switch (s && "object" == typeof s && "function" == typeof s.toJSON && (s = s.toJSON(t)), "function" == typeof rep && (s = rep.call(e, t, s)), typeof s) {
                ...
                case"object":
                    ...
                    if (gap += indent, r = [], "[object Array]" === Object.prototype.toString.apply(s)) {
                        for (o = s.length, i = 0; o > i; i += 1) r[i] = str(i, s) || "null";
                        return a = 0 === r.length ? "[]" : gap ? "[\n" + gap + r.join(",\n" + gap) + "\n" + l + "]" : "[" + r.join(",") + "]", gap = l, a
                    }
                    if (rep && "object" == typeof rep) for (o = rep.length, i = 0; o > i; i += 1) "string" == typeof rep[i] && (n = rep[i], a = str(n, s), a && r.push(quote(n) + (gap ? ": " : ":") + a)); else for (n in s) Object.prototype.hasOwnProperty.call(s, n) && (a = str(n, s), a && r.push(quote(n) + (gap ? ": " : ":") + a));
                    return a = 0 === r.length ? "{}" : gap ? "{\n" + gap + r.join(",\n" + gap) + "\n" + l + "}" : "{" + r.join(",") + "}", gap = l, a
            }
        }
        ...
        "function" != typeof JSON.stringify && (JSON.stringify = function (t, e, i) {
            ...
            function walk(t, e) {
                var i, n, a = t[e];
                if (a && "object" == typeof a) for (i in a) Object.prototype.hasOwnProperty.call(a, i) && (n = walk(a, i), void 0 !== n ? a[i] = n : delete a[i]);
    ...
    var t = ["toJSONString"], e = function (e) {
    ...
    var t, e, i, n, a = "__post_form", o = "__post_iframe", r = (!(!window.ActiveXObject && !window.msIsStaticHTML), 1),
        l = window._formList = [], s = window._iframeList = [], c = function () {
            setTimeout(function () {
                var t = l.shift(), e = s.shift();
                try {
                    t && document.body.removeChild(t), e && document.body.removeChild(e)
                } catch (i) {
                }
            }, 1e3)
        }, p = function (t, e, i) {
            ...
            try {
                for (var o in i) n = document.createElement('<input name="' + o + '"/>'), n.value = i[o], n.type = "hidden", a.appendChild(n)
            } catch (r) {
                for (var o in i) n = document.createElement("input"), n.type = "hidden", n.name = o, n.value = i[o], a.appendChild(n)
            }
    ...
    module.exports = exports = function (c) {
        if (c.action) {
            e = a + r, i = o + r, r++;
            var d = (document.getElementById(e), document.getElementById(i), c.action), u = c.data || {};
            try {
                t = document.createElement('<form id="' + e + '" method="post" action="' + d + '" target="' + i + '"></form>'), n = document.createElement('<iframe name="' + i + '" id="' + i + '" src="javascript:false;"></iframe>')
            } catch (h) {
                t = document.createElement("form"), t.id = e, t.method = "post", t.action = d, t.target = i, n = document.createElement("iframe"), n.name = i, n.id = i
            }
    ...
    var t = 0, e = 1, i = 2, n = 3, a = 4, o = 5, r = 8, l = 9;
    module.exports = exports = function (s) {
        var c, p = t;
        return "undefined" != typeof s._tptype ? {tptype: s._tptype} : ((c = s.roleQQ) ? p = c.value ? e : i : s.roleTEL ? p = n : s.roleKFEXT ? p = o : s.roleGROUP ? p = a : s.rolePUB ? p = r : s.roleIM && (p = l), {tptype: p})
    }
}), LBF.define("wpa.protocol.getQQVersion", "globalSettings,lang.browser,util.events", function (require) {
    var t, e = require("globalSettings"), i = require("lang.browser"), n = require("wpa.util.domEvent");
    return function (a) {
        ...
        if (i.mozilla || i.webkit) {
            var l = document.getElementsByTagName("body")[0], s = document.createElement("iframe"),
                c = e.base + "/protocol/getQQVersion.html";
            return s.style.display = "none", n.addEvent(window, "message", function (e) {
                /https?:\/\/combo\.b\.qq\.com/.test(e.origin) || (t = e.data, a(t), n.removeEvent(window, "message", arguments.callee), s.parentNode.removeChild(s))
            }), s.src = c, void l.insertBefore(s, l.firstChild)
        }
        t = null, a(t)
    }
}), LBF.define("wpa.proto.chatSelect", function (require, exports, module) {
    var t = require("wpa.util.Style"), e = require("wpa.util.domEvent"), i = require("wpa.util.offset"),
        n = require("lang.browser"), a = require("wpa.util.css"), o = require("lang.proxy"), r = require("lang.extend"),
        l = document, s = "BackCompat" === l.compatMode;
    ...
    var p = function (t) {
        this.opts = r({}, c, t), this.render()
    };
    p.prototype = {
        render: function () {
            var t, i = this, n = this.opts, a = this.container = n.container, o = l.createElement("div");
            o.innerHTML = n.template, this.el = t = o.firstChild, function () {
                try {
                    a.appendChild(t)
                } catch (o) {
                    return void setTimeout(arguments.callee, 1)
                }
                e.addEvent(l.getElementById("WPA3-SELECT-PANEL-CLOSE"), "click", function () {
                    i.remove(), n.onClose && n.onClose()
                }), e.addEvent(l.getElementById("WPA3-SELECT-PANEL-AIO-CHAT"), "click", function () {
                    i.remove(), n.onAIOChat && n.onAIOChat()
                }), i.renderModal(), i.setCenter()
            }()
        }, show: function () {
            a(this.el, "display", "block"), a(this.modal, "display", "block")
        }, remove: function () {
            this.el.parentNode.removeChild(this.el), this.modal.parentNode.removeChild(this.modal)
        }, setCenter: function () {
            ...
            if (noPosFix) {
                ...
                setInterval(o(this.el, function () {
                    this.style.top = i.getScrollTop() + e + "px"
                }), 128)
            }
            a(this.el, t)
        }, renderModal: function () {
            var t = this.container, n = (a(t, "width"), a(t, "height"), a(t, "overflow"), l.createElement("div")), r = {
                position: "fixed",
                top: 0,
                left: 0,
                zIndex: 2147483647,
                width: i.getClientWidth() + "px",
                height: i.getClientHeight() + "px",
                backgroundColor: "white",
                opacity: .1,
                filter: "alpha(opacity=10)"
            };
            noPosFix && (r.position = "absolute", setInterval(o(n, function () {
                this.style.top = i.getScrollTop() + "px"
            }), 128)), a(n, r), t.insertBefore(n, this.el), this.modal = n, e.addEvent(window, "resize", o(n, function () {
                a(this.el, {width: i.getClientWidth() + "px", height: i.getClientHeight() + "px"})
            }))
        }, outerWidth: function () {
    ...
    function e(t, e) {
        var i = function (t) {
            var e = /^http(s)?:\/\/([\w\-]+[\.])+qq\.com($|\/)/;
            return e.test(t)
        };
        t = i(t) ? t : "";
        var n = {env: e && e.env || "unknown"}, a = document.createElement("iframe");
        if (a.style.cssText = "display:none; width:0px; height:0px;", "android" == n.env) t = "mqqapi://forward/url?plg_auth=1&url_prefix=" + btoa(t); else if ("ios" == n.env) return t = "mqqapi://forward/url?version=1&src_type=web&url_prefix=" + btoa(t), void setTimeout(function () {
            location.href = t
        }, 300);
        setTimeout(function () {
    ...
    var i = require("lang.browser"), n = require("wpa.conf.config"), a = (n.CGIS, n.isMobile, n.ENV, function () {
        var t = navigator.userAgent.toLowerCase(), e = navigator.userAgent, i = function (e) {
            var i = ("" + (new RegExp(e + "(\\d+((\\.|_)\\d+)*)").exec(t) || [, 0])[1]).replace(/_/g, ".");
            return !!parseFloat(i)
        };
        return {
            is_mqq: /(iPad|iPhone|iPod).*? (IPad)?QQ\/([\d\.]+)/.test(e) || /\bV1_AND_SQI?_([\d\.]+)(.*? QQ\/([\d\.]+))?/.test(e),
            is_ios: i("os "),
            is_android: i("android[/ ]"),
            is_pc: !i("os ") && !i("android[/ ]")
        }
    }());
    exports = module.exports = function (n) {
        return i.isMobile ? void (a.is_ios ? e(t("url", n), {env: "ios"}) : a.is_android && e(t("url", n), {env: "android"})) : alert("仅限移动端呼起")
    }
    ...
    var t = require("lang.browser"), e = require("wpa.conf.config"), i = require("wpa.conf.chat"),
        n = require("util.serialize"), a = (i.LAUNCH_LINK, i.LAUNCH_MOBILE_QQ), o = e.BROWSER_ENV, r = e.isMobile,
        l = e.isSSL, s = t.isIOS, c = (t.isAndroid, o.isInMobileQQ), p = r ? 500 : 0, d = e.gWin, u = d.document,
        h = u.body, f = (navigator.userAgent.toLowerCase(), 0), g = function (t) {
            var e = u.createElement("div");
            e.style.visibility = "hidden", e.style.width = 0, e.style.height = 0, e.innerHTML = '<iframe id="_qd_schema_' + f + '" src="' + t + '" scrolling="no" width="0" height="0"></iframe>', f++, setTimeout(function () {
                h.appendChild(e)
            }, p)
        };
    module.exports = exports = function (t, i) {
        i = i || {};
        var o = "undefined" != typeof i.needMobileJump ? i.needMobileJump : !0, u = n(i), h = i.targetPage, f = h || a;
        r ? c ? setTimeout(function () {
            d.location.href = t
        }, p) : o ? d.location.href = f + "?" + u + "&protocol=" + t : s ? setTimeout(function () {
            d.location.href = t
        }, p) : g(t) : l && !e.BROWSER_ENV.isIE ? d.location.href = t : g(t)
    }
}), LBF.define("wpa.proto.CustomParams", function (require, exports, module) {
    var t = require("wpa.conf.config"), e = require("lang.extend"), i = t.gWin;
    ...
    var t = require("lang.inArray"), e = require("wpa.im.i18n"), i = require("wpa.conf.config"),
        n = (require("wpa.proto.CustomParams"), i.gWin, i.IM_LANG.defaultLang), a = i.IM_LANG.availableList, o = n;
    exports.setLang = function (e) {
        -1 !== t(e, a) && (o = e)
    }, exports.getLang = function () {
        return o
    }, exports.getText = function (t) {
        var i = this.getLang();
        return e[i][t]
    }
    ...
    module.exports = exports = function (t, e) {
        var i = {
            ...
            autoInvited: {
                active: 1,
                reception: {type: 1, cuin: 1232132},
                repeat: {active: !0, finterval: 2, frequency: 1},
                condition: {stayPeriod: 2, deviceType: 1}
            },
            invitedStyle: {
                type: "1",
                title: "客服在线，欢迎咨询",
    ...
    var t = require("wpa.conf.config"), e = t.imageBaseUrl, i = (require("wpa.util.log"), require("lang.browser")),
        n = i.isAndroid || i.isIOS, a = require("util.xssFilter"),
    ...
    var l = exports.btnTypes = {qq: "qq", phone: "phone", im: "im"},
        s = {qq: "icon-qq", phone: "icon-phone", im: "icon-im"}, c = {
            title: "客服在线，欢迎咨询",
            content: "您好，当前有客服在线，点击即可咨询",
            theme: 1,
            btns: {qq: {type: l.qq, text: "QQ交谈"}, phone: {type: l.phone, text: "免费电话"}, im: {type: l.im, text: "立即咨询"}}
        }, p = {
            mobile: {
                tpl: ['<a href="javascript:void(0);" id="invite_close" data-event="close" class="icon-close">', '<img src="' + e + '/invite/icon-close-2x.png" />', "</a>"].join(""),
                css: [".icon-close {position: fixed;top: 6px;right: 6px;}", ".icon-close img {width: 27px;height: 27px;}"].join("")
            },
            pc: {
                tpl: ['<a href="javascript:void(0);" id="invite_close" class="icon-close">', '<img src="' + e + '/invite/icon-close-2x.png" />', "</a>"].join(""),
                css: [".icon-close {position: absolute;right: -2px;top: -2px;z-index: 1000;}"].join("")
            }
        };
    p = n ? p.mobile : p.pc;
    var d = e + "/default-avatar.png";
    __WPA.replaceErrAvatar = function (t) {
        t.src = d, t.onerror = null
    };
    var u = {
        mobile: {
            1: {
    ...
    exports.getTpl = function (t) {
        var e = t.type, i = n ? u.mobile[e] : u.pc[e], a = h(i, t);
        return a
    }, exports.getIframeStyle = function (t, e) {
        var i = r.iframe, a = t.width, o = t.height;
        if (!n) {
            var l = a / 2;
    ...
    module.exports = exports = function (t, e) {
        if (t) {
            e = e || {};
            var i = t.offsetParent, n = t.offsetLeft, a = t.offsetTop;
            if (e.isAbsolute) for (; i;) n += i.offsetLeft, a += i.offsetTop, i = i.offsetParent;
    ...
    function t(t) {
        ...
        var i = t.kfuin, n = t.number, a = b + i, o = document.getElementById(a), r = o.contentWindow,
            l = o.contentDocument || r.document, s = l.getElementById("number");
    ...
    var n = require("lang.browser"), a = (require("wpa.util.getOffset"), require("wpa.conf.config")), o = a.KFUINS,
        r = (a.isMobile, a.BROWSER_ENV.isIOS, a.isFengLing), l = a.gWin,
        s = (a.TYPES.IM, a.WEB_IM.WPAS_IM_TYPE, require("wpa.util.Style"), require("lang.extend")),
        c = require("wpa.util.log"), p = (require("wpa.conf.wpaType"), require("wpa.util.domEvent")),
        d = (require("lang.proxy"), require("wpa.util.onIframeLoaded")), u = require("wpa.im.lang"),
        h = "qidian_wpa_unread_msg_bar", f = (a.WPA_ID_PREFIX, l.__WPA), g = 120, m = 35,
        b = "qidian_wpa_id_unread_msg_bar_", x = 0, v = 45, _ = 80, w = l.document, y = w.body,
        E = (['<div id="unreadBar">', '<span id="unreadNum">9+</span>条新消息', "</div>"].join(""), {}),
    ...
    exports.drawBar = function (e) {
        var i = e.kfuin, a = "undefined" != typeof e.number ? e.number : 0, c = a, I = b + i;
        if ("undefined" == typeof E[i] && (E[i] = x++), document.getElementById(I)) return t(e);
        var A = _ + E[i] * v, S = T + "bottom:" + A + "px;",
        ...
        try {
            ...
            P = w.createElement("iframe"), P.width = g, P.height = m, P.id = I, P.style.cssText = S, P.setAttribute("scrolling", "no"), P.setAttribute("frameborder", 0), P.setAttribute("allowtransparency", !0), P.setAttribute("src", "about:blank"), P.setAttribute("class", h)
        }
        y.appendChild(P), setTimeout(function () {
            ...
            var e = function () {
                var t = P.contentWindow, e = P.contentDocument || t.document;
                ...
                var h = function () {
                    var t = l.__WPA[o][i].unread, e = l.__WPA[o][i].onlyOpen;
                    if ("undefined" != typeof e && !e) {
                        var n = s(l.__WPA[o][i].onlyOpenParam || {}, {kfuin: i, openUnread: !0});
                        return f.IM.openChatIframe(n)
                    }
                    if (e = !1, t) {
                        var a = t.socket, t = t.chat;
                        t > 0 && 0 == a && (e = !0)
                    }
    ...
    var t = require("util.report"), e = require("lang.Class"), i = require("util.serialize"),
        n = require("util.Attribute"), a = {url: "http://isdspeed.qq.com/cgi-bin/r.cgi", rate: 1, calGap: !1},
        o = e.inherit(n, {
            initialize: function (t) {
                this.set(a).set({points: [], start: +new Date}).set(t)
            }, add: function (t, e) {
                var i = this.get("points");
                return t = t || +new Date, e = e || i.length, i[e] = t, this
            }, send: function () {
                var e = this.get("points").splice(0);
                if (Math.random() > this.get("rate")) return this;
                var n, a = this.get("start"), o = this.get("flag1"), r = this.get("flag2"), l = this.get("flag3"),
                    s = this.get("url") + "?flag1=" + o + "&flag2=" + r + "&flag3=" + l + "&", c = this.get("proxy");
                if (this.get("calGap")) for (n = e.length - 1; n > 0; n--) e[n - 1] = e[n - 1] || 0, e[n] -= e[n - 1]; else for (n = e.length - 1; n > 0; n--) e[n] && (e[n] -= a);
                s += i(e), c && (s = c.replace("{url}", encodeURIComponent(s))), t(s)
            }
        }), r = function (e) {
            var i, n, a, o = e.flag1, r = e.flag2, l = e.flag3IE, s = e.flag3Chrome, c = e.initTime, p = e.proxy,
    ...
    return t.topDomain = function () {
        var t = /\.(?:(?:edu|gov|com|org|net)\.cn|co\.nz)$/, i = /^[12]?\d?\d\.[12]?\d?\d\.[12]?\d?\d\.[12]?\d?\d$/,
            n = t.test(e) ? -3 : i.test(e) ? 0 : -2;
        return e.split(".").slice(n).join(".")
    }(), t.domain = function () {
        var i = /(?::[\/]{2}|:[\\]{3})([a-zA-Z0-9_\.]+)/;
        try {
            var n = i.exec(t.url);
            return n ? n[1] || e : e
        } catch (a) {
    ...
    var t = require("lang.extend"), e = require("lang.browser"), i = require("wpa.conf.config"), n = i.gWin,
        a = require("lang.JSON"), o = 2, r = "click", l = 0, s = 1, c = 2, p = 3, d = 4, u = 5, h = 8,
        f = function (t) {
            var e, i = l;
            return (e = t.roleQQ) ? i = e.value ? s : c : t.roleTEL ? i = p : t.roleKFEXT ? i = u : t.roleGROUP ? i = d : t.rolePUB && (i = h), {tptype: i}
        };
    ...
    return {
        htmlEncode: function (t) {
            return (t + "").replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/'/g, "&#39;").replace(/"/g, "&quot;").replace(/ /g, "&nbsp;").replace(/=/g, "&#61;").replace(/`/g, "&#96;")
    ...
    var e = {
        4: {
            0: {n: {s: "#3e87d5", e: "#327ccb", p: "#278cde"}, h: {s: "#499ef8", e: "#327dcc", p: "#4ea9e9"}},
            1: {n: {s: "#0aa60a", e: "#009900", p: "#009900"}, h: {s: "#14b914", e: "#009a00", p: "#3aa93a"}},
            2: {n: {s: "#f5b400", e: "#e0a501", p: "#f5b400"}, h: {s: "#ffc934", e: "#e1a602", p: "#ffc934"}},
            3: {n: {s: "#ee685e", e: "#e05248", p: "#ee685e"}, h: {s: "#f4867e", e: "#e05348", p: "#f3837b"}}
        },
        5: {
            0: {n: {p: "#278cde"}},
            1: {n: {p: "#009900"}},
        ...
        6: {
            0: {n: {p: "#278cde"}, h: {p: "#4ea9e9"}},
            1: {n: {p: "#009900"}, h: {p: "#3aa93a"}},
            2: {n: {p: "#f5b400"}, h: {p: "#ffc934"}},
            3: {n: {p: "#ee685e"}, h: {p: "#f3837b"}}
        },
        8: {
            0: {n: {p: baseUrl + "dialog1_bg_blue.png", p_png8: png8Url + "dialog1_bg_blue.png"}, h: {p: "#278cde"}},
            1: {n: {p: baseUrl + "dialog1_bg_green.png", p_png8: png8Url + "dialog1_bg_green.png"}, h: {p: "#009900"}},
            2: {
                n: {p: baseUrl + "dialog1_bg_yellow.png", p_png8: png8Url + "dialog1_bg_yellow.png"},
                h: {p: "#f5b400"}
            },
            3: {n: {p: baseUrl + "dialog1_bg_pink.png", p_png8: png8Url + "dialog1_bg_pink.png"}, h: {p: "#ee685e"}}
        }
    }, i = {
        4: {
            0: {n: t({tmpl: 1, colors: e[4][0].n}), h: t({tmpl: 1, colors: e[4][0].h})},
            1: {n: t({tmpl: 1, colors: e[4][1].n}), h: t({tmpl: 1, colors: e[4][1].h})},
            2: {n: t({tmpl: 1, colors: e[4][2].n}), h: t({tmpl: 1, colors: e[4][2].h})},
            3: {n: t({tmpl: 1, colors: e[4][3].n}), h: t({tmpl: 1, colors: e[4][3].h})}
        },
        5: {
            0: {n: t({tmpl: 2, colors: e[5][0].n})},
            1: {n: t({tmpl: 2, colors: e[5][1].n})},
            2: {n: t({tmpl: 2, colors: e[5][2].n})},
            3: {n: t({tmpl: 2, colors: e[5][3].n})}
        },
        6: {
            0: {n: t({tmpl: 2, colors: e[6][0].n}), h: t({tmpl: 2, colors: e[6][0].h})},
            1: {n: t({tmpl: 2, colors: e[6][1].n}), h: t({tmpl: 2, colors: e[6][1].h})},
            2: {n: t({tmpl: 2, colors: e[6][2].n}), h: t({tmpl: 2, colors: e[6][2].h})},
            3: {n: t({tmpl: 2, colors: e[6][3].n}), h: t({tmpl: 2, colors: e[6][3].h})}
        },
        8: {
            0: {n: t({tmpl: 3, colors: e[8][0].n}), h: t({tmpl: 2, colors: e[8][0].h})},
            1: {n: t({tmpl: 3, colors: e[8][1].n}), h: t({tmpl: 2, colors: e[8][1].h})},
            2: {n: t({tmpl: 3, colors: e[8][2].n}), h: t({tmpl: 2, colors: e[8][2].h})},
            3: {n: t({tmpl: 3, colors: e[8][3].n}), h: t({tmpl: 2, colors: e[8][3].h})}
        }
    };
    module.exports = exports = i
}), LBF.define("wpa.util.borderRadiusMixin", function (require, exports, module) {
    var t = function (t) {
        return ["-webkit-border-radius: {{radius}}px;", "-moz-border-radius: {{radius}}px;", "border-radius: {{radius}}px;"].join("").replace(/\{\{radius\}\}/g, t || 5)
    }, e = function (t) {
        return ["-webkit-border-top-left-radius: {{radius}}px;", "-moz-border-top-left-radius: {{radius}}px;", "border-top-left-radius: {{radius}}px;", "-webkit-border-top-right-radius: {{radius}}px;", "-moz-border-top-right-radius: {{radius}}px;", "border-top-right-radius: {{radius}}px;"].join("").replace(/\{\{radius\}\}/g, t || 5)
    }, i = function (t) {
        return ["-webkit-border-bottom-left-radius: {{radius}}px;", "-moz-border-bottom-left-radius: {{radius}}px;", "border-bottom-left-radius: {{radius}}px;", "-webkit-border-bottom-right-radius: {{radius}}px;", "-moz-border-bottom-right-radius: {{radius}}px;", "border-bottom-right-radius: {{radius}}px;"].join("").replace(/\{\{radius\}\}/g, t || 5)
    };
    ...
    var t = require("globalSettings"), e = t.png8Url, i = {
        4: {
            blue: e + "fixed4_white_qq_blue.png",
            green: e + "fixed4_white_qq_green.png",
            yellow: e + "fixed4_white_qq_yellow.png",
            pink: e + "fixed4_white_qq_pink.png"
        }
    };
    module.exports = exports = function (t, e) {
        return i[t] ? i[t][e] : void 0
    }
}), LBF.define("wpa.util.replaceImg3X", function (require, exports) {
    return function (t, e) {
        return e > 2 ? t.replace(/2x\.png/g, "3x.png") : t
    }
}), LBF.define("wpa.conf.tpl", function (require, exports, module) {
    var t, e = require("wpa.conf.config"), i = e.imageBaseUrl,
        n = (require("lang.browser"), require("wpa.conf.defaultConst")), a = n.defaultEventTagName,
        o = {1: "callChat", 2: "callPhone", 3: "callAddPal", 4: "callAddGroup", 5: "callAddFan"}, r = {
    ...
    module.exports = exports = function (t, e) {
        ...
        return function (t) {
            t = t || {};
            var e = o[t.event] || o[1], i = y.replace(/\{event\}/g, e);
    ...
    var t = 864e5,
        ...
        i = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], n = function (t) {
            return 10 > t ? "0" + t : t
        }, a = function (t, e) {
            return e = e || new Date(t.getFullYear(), 0, 1), t - e
        }, o = {
            d: function (t) {
                return n(this.j(t))
            }, D: function (t) {
                return this.l(t).substr(0, 3)
            }, j: function (t) {
                return t.getDate()
            }, l: function (t) {
                return i[t.getDay()]
                ...
                return this.F(t).substr(0, 3)
            }, Y: function (t) {
                return t.getFullYear()
            }, y: function (t) {
                return this.Y(t).toString().slice(-2)
            }, a: function (t) {
                return t.getHours() < 12 ? "am" : "pm"
            }, A: function (t) {
                return this.a(t).toUpperCase()
            }, g: function (t) {
            ...
            format: function (t, e) {
                return t = t || "Y-m-d H:i:s", 1 == arguments.length ? e = new Date : e instanceof Date || (e = new Date(parseInt(e) || 0)), t.replace(/\\?([a-z])/gi, function (t, i) {
                    return o[t] ? o[t].call(o, e) : i
                })
            }, isLeapYear: function (t) {
                return t.getTime && (t = r.format("Y", t)), t = parseInt(t, 10), !(0 != t % 4 || t % 100 == 0 && t % 400 != 0)
            }, lastDay: function (e) {
                return new Date(+e - t)
            }, nextDay: function (e) {
                return new Date(+e + t)
            }, lastMonth: function (t) {
                var e = new Date(+t);
                ...
                var e = new Date(+t);
                return e.setYear(e.getFullYear() + 1), e
            }, daysBetween: function (e, i) {
                var n = 60 * (new Date).getTimezoneOffset() * 1e3;
                return parseInt((+i - n) / t, 10) - parseInt((+e - n) / t, 10)
            }, isSameDay: function (t, e) {
                return t = new Date(t), e = new Date(e), t = new Date(t.getFullYear(), t.getMonth(), t.getDate()), e = new Date(e.getFullYear(), e.getMonth(), e.getDate()), 0 === r.daysBetween(t, e)
            }, timestamp: function (t) {
                return parseInt(+t / 1e3, 10)
            }
        };
    return r
}), LBF.define("wpa.util.css", function (require, exports, module) {
    var t = require("util.contains"), e = require("wpa.conf.config"), i = e.gWin, n = i.document,
        a = n.defaultView && n.defaultView.getComputedStyle ? function (t, e) {
            e = e.replace(/([A-Z])/g, "-$1").toLowerCase();
            var i = n.defaultView.getComputedStyle(t, "");
            return i && i.getPropertyValue(e)
        } : function (t, e) {
            return t.currentStyle[e]
        }, o = function (e, i) {
            if (!t(e, n)) return i();
            var a, o = e.parentNode, r = e.nextSibling, l = n.createElement("div");
            return l.appendChild(e), n.body.appendChild(l), a = i(), r ? o.insertBefore(e, r) : o.appendChild(e), l.parentNode.removeChild(l), a
        };
    module.exports = function (t, e, i) {
        var n;
        if (i) n = e + ":" + i; else {
            if ("string" == typeof e) return o(t, function () {
                return a(t, e)
            });
    ...
    module.exports = {"zh-cn": {common_new_message: "条新消息"}, "en-us": {common_new_message: " new message"}}
}), LBF.define("util.Attribute", function (require, exports, module) {
    var t = require("lang.extend"), e = "_ATTRIBUTES", i = "_VALIDATES";
    exports.set = function (i, n, a) {
        var o = this[e];
        if (o || (o = this[e] = {}), "object" != typeof i) {
            var r = o[i];
            return o[i] = n, this.validate(o) ? n === r || a && a.silence || !this.trigger || (this.trigger("change:" + i, [o[i], r]), this.trigger("change", [o])) : o[i] = r, this
        }
        a = n;
        var l = t({}, o, i);
        ...
        return this[e] ? this[e][t] : null
    }, exports.attributes = function () {
        return this[e] || {}
    }, exports.addValidate = function (t) {
        var e = this[i];
        return e || (e = this[i] = []), e.push(t), this
    }, exports.removeValidate = function (t) {
        if (!t) return this[i] = null, this;
        for (var e = this[i], n = 0, a = e.length; a > n; n++) e[n] === t && (e.splice(n, 1), --n, --a);
        return this
    }, exports.validate = function (t) {
        var n = this[i];
        if (!n) return !0;
        t = t || this[e];
        for (var a = 0, o = n.length; o > a; a++) if (n[a].call(this, t) === !1) return !1;
        return !0
    }
    ...
    return document.createElement("div").compareDocumentPosition ? function (t, e, i) {
        if (!i && t === e) return !1;
        var n = t.compareDocumentPosition(e);
        return 20 == n || 0 == n
    } : function (t, e, i) {
        return i || t !== e ? e == document ? t.contains(document.body) : t.contains(e) : !1
    }
}), LBF.use("wpa.app", function (t) {
    t.init(), t.lbf = LBF, LBF.noConflict()
});