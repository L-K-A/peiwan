...
define([
	...
	'layer',
	'laypage',
	public_domain+'/static/login_registration.js',
	public_domain + '/static/websocket.js',
	public_domain + '/static/message.js',
	public_domain + '/static/chat.js'
		...
		var modal = {
        	...
        	levelImgFun2: function(level) {//等级图片
                var imgUrl= public_domain + "/images/";
                var imgind = 0;
                if(level){
                    imgind=level-1;
                }else {
			...
			*/
			clothes_small_path_fn: function (type) {
				var img_url = public_domain+"/images/";
				return img_url + type + ".png";
			},
			/**
			*返回衣服大图
