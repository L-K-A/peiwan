(function (a, c) {
    ...
    var l = function (s, v, r) {
        var q, t = 0, u = s.length, p = u === c || Object.prototype.toString(s) === "[object Function]";
        if (r) {
            if (p) {
                for (q in s) {
    ...
    var f = function () {
        ...
        var r = i;
        return function (v) {
            var u = v.url || p, x = v.level || t, w = (r.isString(v) ? v : v.info) || "Empty info!";
            if (e.debug) {
    ...
    h("util.getScript", function () {
        return function (q, s) {
            var p = document.createElement("script"), r = document.getElementsByTagName("head")[0];
            setTimeout(function () {
                if (!r) {
    ...
    h("api.require", "globalSettings,lang.each,lang.trim,lang.typeEnhance,util.pubSub,util.combo,util.getRequireList", function (s) {
        var w = s("globalSettings"), t = s("typeEnhance"), u = s("each"), p = s("trim"), q = s("pubSub"),
            v = s("combo"), r = s("getRequireList");
