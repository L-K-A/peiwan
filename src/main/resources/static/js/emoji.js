"use strict";
(function () {
    var f = this, e = f.EmojiConvertor, a = function () {
        var f = this;
        ...
        }, f.use_css_imgs = !1, f.colons_mode = !1, f.text_mode = !1, f.include_title = !1, f.include_text = !1, f.allow_native = !0, f.use_sheet = !1, f.avoid_ms_emoji = !0, f.allow_caps = !1, f.img_suffix = "", f.inits = {}, f.map = {}, f.init_env(), f
    };
    a.prototype.noConflict = function () {
        return f.EmojiConvertor = e, a
    }, a.prototype.replace_emoticons = function (f) {
        var e = this, a = e.replace_emoticons_with_colons(f);
        return e.replace_colons(a)
    }, a.prototype.replace_emoticons_with_colons = function (f) {
        var e = this;
        e.init_emoticons();
        var a = 0, o = [], n = f.replace(e.rx_emoticons, function (n, l, t, i) {
            var r = a;
            a = i + n.length;
            var c = -1 !== t.indexOf("("), _ = -1 !== t.indexOf(")");
            if ((c || _) && -1 == o.indexOf(t) && o.push(t), _ && !c) {
                var s = f.substring(r, i);
                if (-1 !== s.indexOf("(") && -1 === s.indexOf(")")) return n
            }
            if ("\n8)" === n) {
        ...
        if (o.length) {
            var l = o.map(e.escape_rx), t = new RegExp("(\\(.+)(" + l.join("|") + ")(.+\\))", "g");
            n = n.replace(t, function (f, a, o, n) {
                var l = e.data[e.map.emoticons[o]][3][0];
                return l ? a + ":" + l + ":" + n : f
            })
        }
        return n
        ...
        return e.init_colons(), f.replace(e.rx_colons, function (f) {
            ...
            if (e.allow_caps && (a = a.toLowerCase()), a.indexOf("::skin-tone-") > -1) {
                var o = a.substr(-1, 1), n = "skin-tone-" + o, l = e.map.colons[n];
                a = a.substr(0, a.length - 13);
                var t = e.map.colons[a];
                return t ? e.replacement(t, a, ":", {
                    idx: l,
                    actual: n,
                    wrapper: ":"
                }) : ":" + a + ":" + e.replacement(l, n, ":")
            ...
            var t = e.map.colons[a];
            return t ? e.replacement(t, a, ":") : f
        })
    }, a.prototype.replace_unified = function (f) {
        var e = this;
        return e.init_unified(), f.replace(e.rx_unified, function (f, a, o) {
            var n = e.map.unified[a];
            if (!n) return f;
            var l = null;
            return "🏻" == o && (l = "1f3fb"), "🏼" == o && (l = "1f3fc"), "🏽" == o && (l = "1f3fd"), "🏾" == o && (l = "1f3fe"), "🏿" == o && (l = "1f3ff"), l ? e.replacement(n, null, null, {
                idx: l,
                actual: o,
                wrapper: ""
            }) : e.replacement(n)
        ...
        for (var e = this, a = 0; a < f.length; a++) {
            ...
            f:for (var n in e.data) for (var l = 0; l < e.data[n][3].length; l++) if (o == e.data[n][3][l]) {
                e.map.colons[o] = n;
                break f
            }
        }
    }, a.prototype.replacement = function (f, e, a, o) {
        var n = this, l = f, t = "", i = 0;
        "object" == typeof o && (t = n.replacement(o.idx, o.actual, o.wrapper), i = f + "-" + o.idx);
        var r = n.img_set;
        if (n.use_sheet && n.supports_css || n.data[f][6] & n.img_sets[n.img_set].mask || (r = "apple"), a = a || "", n.colons_mode) return ":" + n.data[f][3][0] + ":" + t;
        var c = e ? a + e + a : n.data[f][8] || a + n.data[f][3][0] + a;
        if (n.text_mode) return c + t;
        if (n.init_env(), "unified" == n.replace_mode && n.allow_native && n.data[f][0][0]) return n.data[f][0][0] + t;
        if ("softbank" == n.replace_mode && n.allow_native && n.data[f][1]) return n.data[f][1] + t;
        if ("google" == n.replace_mode && n.allow_native && n.data[f][2]) return n.data[f][2] + t;
        var _ = n.data[f][7] || n.img_sets[r].path + f + ".png" + n.img_suffix,
            s = n.include_title ? ' title="' + (e || n.data[f][3][0]) + '"' : "",
            d = n.include_text ? a + (e || n.data[f][3][0]) + a : "", g = n.data[f][4], b = n.data[f][5];
        return i && n.variations_data[i] && n.variations_data[i][2] && !n.data[f][7] && n.variations_data[i][2] & n.img_sets[n.img_set].mask && (_ = n.img_sets[n.img_set].path + i + ".png", g = n.variations_data[i][0], b = n.variations_data[i][1], t = "", l = i, n.include_text && o && o.actual && o.wrapper && (d += o.wrapper + o.actual + o.wrapper)), '<img src="' + _ + '" class="emoji" data-codepoints="' + l + '" ' + s + "/>" + t
        ...
        if (!f.inits.emoticons) {
            ...
            for (var a in f.emoticons_data) {
                ...
                f.map.colons[f.emoticons_data[a]] && (f.map.emoticons[o] = f.map.colons[f.emoticons_data[a]], e.push(f.escape_rx(o)))
            }
        ...
        var f = this;
        if (!f.inits.colons) {
            f.inits.colons = 1, f.rx_colons = new RegExp(":[a-zA-Z0-9-_+]+:(:skin-tone-[2-6]:)?", "g"), f.map.colons = {};
            for (var e in f.data) for (var a = 0; a < f.data[e][3].length; a++) f.map.colons[f.data[e][3][a]] = e
        }
        ...
        if (!f.inits.unified) {
            ...
            var e = [];
            f.map.unified = {};
            for (var a in f.data) for (var o = 0; o < f.data[a][0].length; o++) e.push(f.data[a][0][o].replace("*", "\\*")), f.map.unified[f.data[a][0][o]] = a;
        ...
        var f = this;
        f.inits.env || (f.inits.env = 1, f.replace_mode = "img", f.supports_css = !1)
    ...
    }, "undefined" != typeof exports ? ("undefined" != typeof module && module.exports && (exports = module.exports = a), exports.EmojiConvertor = a) : "function" == typeof define && define.amd ? define(function () {
        return a
    }) : f.EmojiConvertor = a
}).call(function () {
