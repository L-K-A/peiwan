...
//  给用户表里插入一条数据
    @Insert("INSERT INTO t_person(person_nickname,person_pwd,person_pwdencry,person_createtime) VALUES(#{personNickname},#{personPwd},#{personPwdencry},#{personCreatetime})")
