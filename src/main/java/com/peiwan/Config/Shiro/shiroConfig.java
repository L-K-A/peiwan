...
public class shiroConfig {
    ...
    public ShiroFilterFactoryBean getShiroFilterFactoryBean(@Qualifier("securityManager")DefaultWebSecurityManager securityManager){
        ...
        /*下单限定*/
        filterMap.put("/oisert","authc");
        /*关注*/
        filterMap.put("/insertAttention","authc");
        /*用户个人中心限定*/
        filterMap.put("/indexw","authc");
        filterMap.put("/index.html","authc");
        filterMap.put("/atten","authc");
        filterMap.put("/secur","authc");
        filterMap.put("/trecord","authc");
        filterMap.put("/data","authc");
        filterMap.put("/playinfo","authc");
        /*end*/
        /*用户个人中心限定*/
        filterMap.put("/zindexw","authc");
        filterMap.put("/zatten","authc");
        filterMap.put("/zsecur","authc");
        filterMap.put("/ztrecord","authc");
        filterMap.put("/zdata","authc");
        filterMap.put("/zplayinfo","authc");
        /*end*/
//授权过滤器
